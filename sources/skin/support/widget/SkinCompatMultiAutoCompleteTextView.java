...
public class SkinCompatMultiAutoCompleteTextView extends AppCompatMultiAutoCompleteTextView implements SkinCompatSupportable {
    ...
    public SkinCompatMultiAutoCompleteTextView(Context context, AttributeSet attrs) {
        this(context, attrs, C1899R.attr.editTextStyle);
    }
    ...
    @Override // android.support.p004v7.widget.AppCompatMultiAutoCompleteTextView, android.widget.AutoCompleteTextView
    ...
    @Override // android.support.p004v7.widget.AppCompatMultiAutoCompleteTextView, android.view.View
