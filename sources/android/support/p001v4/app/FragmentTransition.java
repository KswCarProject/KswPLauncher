...
class FragmentTransition {
    ...
    public static void calculateFragments(BackStackRecord transaction, SparseArray<FragmentContainerTransition> transitioningFragments, boolean isReordered) {
        ...
        for (int opNum = 0; opNum < numOps; opNum++) {
            BackStackRecord.C0180Op op = transaction.mOps.get(opNum);
    ...
    private static void addToFirstInLastOut(BackStackRecord transaction, BackStackRecord.C0180Op op, SparseArray<FragmentContainerTransition> transitioningFragments, boolean isPop, boolean isReorderedTransaction) {
        int containerId;
        boolean setLastIn;
        boolean setLastIn2;
        boolean wasRemoved;
