...
public class ViewCompat {
    ...
    public static void addOnUnhandledKeyEventListener(View v, OnUnhandledKeyEventListenerCompat listener) {
        if (Build.VERSION.SDK_INT >= 28) {
            Map<OnUnhandledKeyEventListenerCompat, View.OnUnhandledKeyEventListener> viewListeners = (Map) v.getTag(C0082R.C0084id.tag_unhandled_key_listeners);
            if (viewListeners == null) {
                viewListeners = new ArrayMap<>();
                v.setTag(C0082R.C0084id.tag_unhandled_key_listeners, viewListeners);
            }
        ...
        ArrayList<OnUnhandledKeyEventListenerCompat> viewListeners2 = (ArrayList) v.getTag(C0082R.C0084id.tag_unhandled_key_listeners);
        if (viewListeners2 == null) {
            viewListeners2 = new ArrayList<>();
            v.setTag(C0082R.C0084id.tag_unhandled_key_listeners, viewListeners2);
        }
    ...
    static boolean dispatchUnhandledKeyEventBeforeHierarchy(View root, KeyEvent evt) {
        ...
        return UnhandledKeyEventManager.m51at(root).preDispatch(evt);
    }
    ...
    static boolean dispatchUnhandledKeyEventBeforeCallback(View root, KeyEvent evt) {
        ...
        return UnhandledKeyEventManager.m51at(root).dispatch(root, evt);
    }
    ...
    static class UnhandledKeyEventManager {
        ...
        /* renamed from: at */
        static UnhandledKeyEventManager m51at(View root) {
            UnhandledKeyEventManager manager = (UnhandledKeyEventManager) root.getTag(C0082R.C0084id.tag_unhandled_key_event_manager);
            if (manager == null) {
                UnhandledKeyEventManager manager2 = new UnhandledKeyEventManager();
                root.setTag(C0082R.C0084id.tag_unhandled_key_event_manager, manager2);
                return manager2;
            }
            return manager;
        }
        ...
        private boolean onUnhandledKeyEvent(View v, KeyEvent event) {
            ArrayList<OnUnhandledKeyEventListenerCompat> viewListeners = (ArrayList) v.getTag(C0082R.C0084id.tag_unhandled_key_listeners);
            if (viewListeners != null) {
