...
public final class ViewPropertyAnimatorCompat {
    ...
    /* renamed from: x */
    public ViewPropertyAnimatorCompat m50x(float value) {
        View view = this.mView.get();
        if (view != null) {
    ...
    /* renamed from: y */
    public ViewPropertyAnimatorCompat m49y(float value) {
        View view = this.mView.get();
        if (view != null) {
    ...
    /* renamed from: z */
    public ViewPropertyAnimatorCompat m48z(float value) {
        View view = this.mView.get();
        if (view != null && Build.VERSION.SDK_INT >= 21) {
