...
public class FontResourcesParserCompat {
    ...
    private static FamilyResourceEntry readFamily(XmlPullParser parser, Resources resources) throws XmlPullParserException, IOException {
        ...
        TypedArray array = resources.obtainAttributes(attrs, C0082R.styleable.FontFamily);
        String authority = array.getString(C0082R.styleable.FontFamily_fontProviderAuthority);
        String providerPackage = array.getString(C0082R.styleable.FontFamily_fontProviderPackage);
        String query = array.getString(C0082R.styleable.FontFamily_fontProviderQuery);
        int certsId = array.getResourceId(C0082R.styleable.FontFamily_fontProviderCerts, 0);
        int strategy = array.getInteger(C0082R.styleable.FontFamily_fontProviderFetchStrategy, 1);
        int timeoutMs = array.getInteger(C0082R.styleable.FontFamily_fontProviderFetchTimeout, 500);
        array.recycle();
    ...
    private static FontFileResourceEntry readFont(XmlPullParser parser, Resources resources) throws XmlPullParserException, IOException {
        AttributeSet attrs = Xml.asAttributeSet(parser);
        TypedArray array = resources.obtainAttributes(attrs, C0082R.styleable.FontFamilyFont);
        int weightAttr = array.hasValue(C0082R.styleable.FontFamilyFont_fontWeight) ? C0082R.styleable.FontFamilyFont_fontWeight : C0082R.styleable.FontFamilyFont_android_fontWeight;
        int weight = array.getInt(weightAttr, 400);
        int styleAttr = array.hasValue(C0082R.styleable.FontFamilyFont_fontStyle) ? C0082R.styleable.FontFamilyFont_fontStyle : C0082R.styleable.FontFamilyFont_android_fontStyle;
        boolean isItalic = 1 == array.getInt(styleAttr, 0);
        int ttcIndexAttr = array.hasValue(C0082R.styleable.FontFamilyFont_ttcIndex) ? C0082R.styleable.FontFamilyFont_ttcIndex : C0082R.styleable.FontFamilyFont_android_ttcIndex;
        int variationSettingsAttr = array.hasValue(C0082R.styleable.FontFamilyFont_fontVariationSettings) ? C0082R.styleable.FontFamilyFont_fontVariationSettings : C0082R.styleable.FontFamilyFont_android_fontVariationSettings;
        String variationSettings = array.getString(variationSettingsAttr);
        int ttcIndex = array.getInt(ttcIndexAttr, 0);
        int resourceAttr = array.hasValue(C0082R.styleable.FontFamilyFont_font) ? C0082R.styleable.FontFamilyFont_font : C0082R.styleable.FontFamilyFont_android_font;
