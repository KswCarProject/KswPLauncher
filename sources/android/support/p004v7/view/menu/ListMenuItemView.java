...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView, AbsListView.SelectionBoundsAdjuster {
    ...
    public ListMenuItemView(Context context, AttributeSet attrs) {
        this(context, attrs, C0365R.attr.listMenuViewStyle);
    }

    public ListMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs);
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(getContext(), attrs, C0365R.styleable.MenuView, defStyleAttr, 0);
        this.mBackground = a.getDrawable(C0365R.styleable.MenuView_android_itemBackground);
        this.mTextAppearance = a.getResourceId(C0365R.styleable.MenuView_android_itemTextAppearance, -1);
        this.mPreserveIconSpacing = a.getBoolean(C0365R.styleable.MenuView_preserveIconSpacing, false);
        this.mTextAppearanceContext = context;
        this.mSubMenuArrow = a.getDrawable(C0365R.styleable.MenuView_subMenuArrow);
        TypedArray b = context.getTheme().obtainStyledAttributes(null, new int[]{16843049}, C0365R.attr.dropDownListViewStyle, 0);
    ...
    protected void onFinishInflate() {
        ...
        TextView textView = (TextView) findViewById(C0365R.C0367id.title);
        this.mTitleView = textView;
        int i = this.mTextAppearance;
        if (i != -1) {
            textView.setTextAppearance(this.mTextAppearanceContext, i);
        }
        this.mShortcutView = (TextView) findViewById(C0365R.C0367id.shortcut);
        ImageView imageView = (ImageView) findViewById(C0365R.C0367id.submenuarrow);
        this.mSubMenuArrowView = imageView;
        if (imageView != null) {
            imageView.setImageDrawable(this.mSubMenuArrow);
        }
        this.mGroupDivider = (ImageView) findViewById(C0365R.C0367id.group_divider);
        this.mContent = (LinearLayout) findViewById(C0365R.C0367id.content);
    }
    ...
    private void insertIconView() {
        ...
        ImageView imageView = (ImageView) inflater.inflate(C0365R.C0368layout.abc_list_menu_item_icon, (ViewGroup) this, false);
    ...
    private void insertRadioButton() {
        LayoutInflater inflater = getInflater();
        RadioButton radioButton = (RadioButton) inflater.inflate(C0365R.C0368layout.abc_list_menu_item_radio, (ViewGroup) this, false);
    ...
    private void insertCheckBox() {
        LayoutInflater inflater = getInflater();
        CheckBox checkBox = (CheckBox) inflater.inflate(C0365R.C0368layout.abc_list_menu_item_checkbox, (ViewGroup) this, false);
