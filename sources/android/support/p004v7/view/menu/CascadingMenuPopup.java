...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    private static final int ITEM_LAYOUT = C0365R.C0368layout.abc_cascading_menu_item_layout;
    ...
    public CascadingMenuPopup(Context context, View anchor, int popupStyleAttr, int popupStyleRes, boolean overflowOnly) {
        ...
        this.mMenuMaxWidth = Math.max(res.getDisplayMetrics().widthPixels / 2, res.getDimensionPixelSize(C0365R.dimen.abc_config_prefDialogWidth));
    ...
    private void showMenu(MenuBuilder menu) {
        ...
        if (parentInfo == null && this.mShowTitle && menu.getHeaderTitle() != null) {
            FrameLayout titleItemView = (FrameLayout) inflater.inflate(C0365R.C0368layout.abc_popup_menu_header_item_layout, (ViewGroup) listView, false);
