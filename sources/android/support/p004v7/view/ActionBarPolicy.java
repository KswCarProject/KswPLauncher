...
public class ActionBarPolicy {
    ...
    public boolean hasEmbeddedTabs() {
        return this.mContext.getResources().getBoolean(C0365R.bool.abc_action_bar_embed_tabs);
    }
    ...
    public int getTabContainerHeight() {
        ...
        if (!hasEmbeddedTabs()) {
            height = Math.min(height, r.getDimensionPixelSize(C0365R.dimen.abc_action_bar_stacked_max_height));
        }
        a.recycle();
        return height;
    }
    ...
    public int getStackedTabMaxWidth() {
        return this.mContext.getResources().getDimensionPixelSize(C0365R.dimen.abc_action_bar_stacked_tab_max_width);
    }
}
