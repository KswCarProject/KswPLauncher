...
import android.support.p004v7.cardview.C0369R;
...
public class CardView extends FrameLayout {
    ...
    public CardView(Context context, AttributeSet attrs) {
        this(context, attrs, C0369R.attr.cardViewStyle);
    }
    ...
    public CardView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0369R.styleable.CardView, defStyleAttr, C0369R.style.CardView);
        if (a.hasValue(C0369R.styleable.CardView_cardBackgroundColor)) {
            backgroundColor = a.getColorStateList(C0369R.styleable.CardView_cardBackgroundColor);
        } else {
            ...
            if (hsv[2] > 0.5f) {
                color = getResources().getColor(C0369R.color.cardview_light_background);
            } else {
                color = getResources().getColor(C0369R.color.cardview_dark_background);
            }
            backgroundColor = ColorStateList.valueOf(color);
        }
        float radius = a.getDimension(C0369R.styleable.CardView_cardCornerRadius, 0.0f);
        float elevation = a.getDimension(C0369R.styleable.CardView_cardElevation, 0.0f);
        float maxElevation2 = a.getDimension(C0369R.styleable.CardView_cardMaxElevation, 0.0f);
        this.mCompatPadding = a.getBoolean(C0369R.styleable.CardView_cardUseCompatPadding, false);
        this.mPreventCornerOverlap = a.getBoolean(C0369R.styleable.CardView_cardPreventCornerOverlap, true);
        int defaultPadding = a.getDimensionPixelSize(C0369R.styleable.CardView_contentPadding, 0);
        rect.left = a.getDimensionPixelSize(C0369R.styleable.CardView_contentPaddingLeft, defaultPadding);
        rect.top = a.getDimensionPixelSize(C0369R.styleable.CardView_contentPaddingTop, defaultPadding);
        rect.right = a.getDimensionPixelSize(C0369R.styleable.CardView_contentPaddingRight, defaultPadding);
        rect.bottom = a.getDimensionPixelSize(C0369R.styleable.CardView_contentPaddingBottom, defaultPadding);
        if (elevation <= maxElevation2) {
            maxElevation = maxElevation2;
        } else {
            maxElevation = elevation;
        }
        this.mUserSetMinWidth = a.getDimensionPixelSize(C0369R.styleable.CardView_android_minWidth, 0);
        this.mUserSetMinHeight = a.getDimensionPixelSize(C0369R.styleable.CardView_android_minHeight, 0);
        a.recycle();
