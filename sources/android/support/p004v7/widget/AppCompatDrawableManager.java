...
public final class AppCompatDrawableManager {
    ...
    private Drawable tintDrawable(Context context, int resId, boolean failIfNotKnown, Drawable drawable) {
        ...
        if (tintList != null) {
            ...
            int themeAttrColor = ThemeUtils.getThemeAttrColor(context, C0365R.attr.colorControlNormal);
            PorterDuff.Mode mode = DEFAULT_MODE;
            setPorterDuffColorFilter(findDrawableByLayerId, themeAttrColor, mode);
            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, C0365R.attr.colorControlNormal), mode);
            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0365R.attr.colorControlActivated), mode);
            return drawable;
            ...
            int disabledThemeAttrColor = ThemeUtils.getDisabledThemeAttrColor(context, C0365R.attr.colorControlNormal);
            PorterDuff.Mode mode2 = DEFAULT_MODE;
            setPorterDuffColorFilter(findDrawableByLayerId2, disabledThemeAttrColor, mode2);
            setPorterDuffColorFilter(ld2.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, C0365R.attr.colorControlActivated), mode2);
            setPorterDuffColorFilter(ld2.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0365R.attr.colorControlActivated), mode2);
            return drawable;
        } else {
    ...
    synchronized ColorStateList getTintList(Context context, int resId) {
        ...
        if (tint == null) {
            if (resId == C0365R.C0366drawable.abc_edit_text_material) {
                tint = AppCompatResources.getColorStateList(context, C0365R.color.abc_tint_edittext);
            } else if (resId == C0365R.C0366drawable.abc_switch_track_mtrl_alpha) {
                tint = AppCompatResources.getColorStateList(context, C0365R.color.abc_tint_switch_track);
                ...
                if (resId != C0365R.C0366drawable.abc_spinner_mtrl_am_alpha && resId != C0365R.C0366drawable.abc_spinner_textfield_background_material) {
                    if (arrayContains(TINT_COLOR_CONTROL_NORMAL, resId)) {
                        tint = ThemeUtils.getThemeAttrColorStateList(context, C0365R.attr.colorControlNormal);
                    } else if (arrayContains(TINT_COLOR_CONTROL_STATE_LIST, resId)) {
                        tint = AppCompatResources.getColorStateList(context, C0365R.color.abc_tint_default);
                    } else if (arrayContains(TINT_CHECKABLE_BUTTON_LIST, resId)) {
                        tint = AppCompatResources.getColorStateList(context, C0365R.color.abc_tint_btn_checkable);
                    } else if (resId == C0365R.C0366drawable.abc_seekbar_thumb_material) {
                        tint = AppCompatResources.getColorStateList(context, C0365R.color.abc_tint_seek_thumb);
                    }
                }
                tint = AppCompatResources.getColorStateList(context, C0365R.color.abc_tint_spinner);
            }
            if (tint != null) {
    ...
    private ColorStateList createDefaultButtonColorStateList(Context context) {
        return createButtonColorStateList(context, ThemeUtils.getThemeAttrColor(context, C0365R.attr.colorButtonNormal));
    }
    ...
    private ColorStateList createColoredButtonColorStateList(Context context) {
        return createButtonColorStateList(context, ThemeUtils.getThemeAttrColor(context, C0365R.attr.colorAccent));
    }

    private ColorStateList createButtonColorStateList(Context context, int baseColor) {
        int[][] states = new int[4];
        int[] colors = new int[4];
        int colorControlHighlight = ThemeUtils.getThemeAttrColor(context, C0365R.attr.colorControlHighlight);
        int disabledColor = ThemeUtils.getDisabledThemeAttrColor(context, C0365R.attr.colorButtonNormal);
    ...
    private ColorStateList createSwitchThumbColorStateList(Context context) {
        ...
        ColorStateList thumbColor = ThemeUtils.getThemeAttrColorStateList(context, C0365R.attr.colorSwitchThumbNormal);
        if (thumbColor == null || !thumbColor.isStateful()) {
            states[0] = ThemeUtils.DISABLED_STATE_SET;
            colors[0] = ThemeUtils.getDisabledThemeAttrColor(context, C0365R.attr.colorSwitchThumbNormal);
            int i = 0 + 1;
            states[i] = ThemeUtils.CHECKED_STATE_SET;
            colors[i] = ThemeUtils.getThemeAttrColor(context, C0365R.attr.colorControlActivated);
            int i2 = i + 1;
            states[i2] = ThemeUtils.EMPTY_STATE_SET;
            colors[i2] = ThemeUtils.getThemeAttrColor(context, C0365R.attr.colorSwitchThumbNormal);
            int i3 = i2 + 1;
        } else {
            states[0] = ThemeUtils.DISABLED_STATE_SET;
            ...
            colors[i4] = ThemeUtils.getThemeAttrColor(context, C0365R.attr.colorControlActivated);
            int i5 = i4 + 1;
