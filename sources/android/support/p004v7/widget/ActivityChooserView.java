...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray attributesArray = context.obtainStyledAttributes(attrs, C0365R.styleable.ActivityChooserView, defStyle, 0);
        this.mInitialActivityCount = attributesArray.getInt(C0365R.styleable.ActivityChooserView_initialActivityCount, 4);
        Drawable expandActivityOverflowButtonDrawable = attributesArray.getDrawable(C0365R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
        attributesArray.recycle();
        LayoutInflater inflater = LayoutInflater.from(getContext());
        inflater.inflate(C0365R.C0368layout.abc_activity_chooser_view, (ViewGroup) this, true);
        Callbacks callbacks = new Callbacks();
        this.mCallbacks = callbacks;
        View findViewById = findViewById(C0365R.C0367id.activity_chooser_view_content);
        this.mActivityChooserContent = findViewById;
        this.mActivityChooserContentBackground = findViewById.getBackground();
        FrameLayout frameLayout = (FrameLayout) findViewById(C0365R.C0367id.default_activity_button);
        ...
        this.mDefaultActivityButtonImage = (ImageView) frameLayout.findViewById(C0365R.C0367id.image);
        FrameLayout expandButton = (FrameLayout) findViewById(C0365R.C0367id.expand_activities_button);
        ...
        ImageView imageView = (ImageView) expandButton.findViewById(C0365R.C0367id.image);
        ...
        this.mListPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0365R.dimen.abc_config_prefDialogWidth));
    }
    ...
    void showPopupUnchecked(int maxActivityCount) {
        ...
        if (!popupWindow.isShowing()) {
            ...
            popupWindow.getListView().setContentDescription(getContext().getString(C0365R.string.abc_activitychooserview_choose_application));
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            switch (itemViewType) {
                case 0:
                    if (convertView == null || convertView.getId() != C0365R.C0367id.list_item) {
                        convertView = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0365R.C0368layout.abc_activity_chooser_view_list_item, parent, false);
                    }
                    PackageManager packageManager = ActivityChooserView.this.getContext().getPackageManager();
                    ImageView iconView = (ImageView) convertView.findViewById(C0365R.C0367id.icon);
                    ResolveInfo activity = (ResolveInfo) getItem(position);
                    iconView.setImageDrawable(activity.loadIcon(packageManager));
                    TextView titleView = (TextView) convertView.findViewById(C0365R.C0367id.title);
                ...
                case 1:
                    if (convertView == null || convertView.getId() != 1) {
                        View convertView2 = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0365R.C0368layout.abc_activity_chooser_view_list_item, parent, false);
                        convertView2.setId(1);
                        TextView titleView2 = (TextView) convertView2.findViewById(C0365R.C0367id.title);
                        titleView2.setText(ActivityChooserView.this.getContext().getString(C0365R.string.abc_activity_chooser_view_see_all));
                        return convertView2;
                    }
                    return convertView;
                default:
