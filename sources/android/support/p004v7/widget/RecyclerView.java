...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public RecyclerView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            TypedArray a2 = context.obtainStyledAttributes(attrs, C0372R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a2.getString(C0372R.styleable.RecyclerView_layoutManager);
            int descendantFocusability = a2.getInt(C0372R.styleable.RecyclerView_android_descendantFocusability, -1);
            if (descendantFocusability == -1) {
                setDescendantFocusability(262144);
            }
            boolean z2 = a2.getBoolean(C0372R.styleable.RecyclerView_fastScrollEnabled, false);
            this.mEnableFastScroller = z2;
            if (z2) {
                StateListDrawable verticalThumbDrawable = (StateListDrawable) a2.getDrawable(C0372R.styleable.RecyclerView_fastScrollVerticalThumbDrawable);
                Drawable verticalTrackDrawable = a2.getDrawable(C0372R.styleable.RecyclerView_fastScrollVerticalTrackDrawable);
                StateListDrawable horizontalThumbDrawable = (StateListDrawable) a2.getDrawable(C0372R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable);
                Drawable horizontalTrackDrawable = a2.getDrawable(C0372R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable);
    ...
    */
    ...
    public static abstract class LayoutManager {
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0372R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0372R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0372R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0372R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0372R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        ...
        new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, resources.getDimensionPixelSize(C0372R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0372R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0372R.dimen.fastscroll_margin));
    }
