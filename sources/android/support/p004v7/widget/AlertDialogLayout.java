    ...
    private boolean tryOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != 8) {
                int id = child.getId();
                if (id == C0365R.C0367id.topPanel) {
                    topPanel = child;
                } else if (id == C0365R.C0367id.buttonPanel) {
                    buttonPanel = child;
                } else if ((id != C0365R.C0367id.contentPanel && id != C0365R.C0367id.customPanel) || middlePanel != null) {
                    return false;
                } else {
                    middlePanel = child;
                }
