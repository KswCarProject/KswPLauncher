...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, C0365R.styleable.ButtonBarLayout);
        this.mAllowStacking = ta.getBoolean(C0365R.styleable.ButtonBarLayout_allowStacking, true);
        ta.recycle();
    }
    ...
    private void setStacked(boolean stacked) {
        ...
        View spacer = findViewById(C0365R.C0367id.spacer);
        if (spacer != null) {
