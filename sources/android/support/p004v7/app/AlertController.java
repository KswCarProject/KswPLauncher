...
class AlertController {
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0365R.attr.alertDialogCenterButtons, outValue, true);
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes(null, C0365R.styleable.AlertDialog, C0365R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a.getResourceId(C0365R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a.getResourceId(C0365R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a.getResourceId(C0365R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a.getResourceId(C0365R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a.getResourceId(C0365R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a.getResourceId(C0365R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = a.getBoolean(C0365R.styleable.AlertDialog_showTitle, true);
        this.mButtonIconDimen = a.getDimensionPixelSize(C0365R.styleable.AlertDialog_buttonIconDimen, 0);
        a.recycle();
    ...
    /* JADX WARN: Code restructure failed: missing block: B:34:0x009f, code lost:
        r1 = r9.findViewById(android.support.p004v7.appcompat.C0365R.C0367id.titleDividerNoCustom);
     */
    ...
    */
    private void setupView() {
        ...
        View spacer2;
        View parentPanel = this.mWindow.findViewById(C0365R.C0367id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C0365R.C0367id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C0365R.C0367id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C0365R.C0367id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C0365R.C0367id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C0365R.C0367id.topPanel);
        View customContentPanel = customPanel.findViewById(C0365R.C0367id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C0365R.C0367id.buttonPanel);
        ...
        if (!hasButtonPanel && contentPanel != null && (spacer2 = contentPanel.findViewById(C0365R.C0367id.textSpacerNoButtons)) != null) {
            spacer2.setVisibility(0);
        }
        if (contentPanel != null && (spacer = contentPanel.findViewById(C0365R.C0367id.textSpacerNoTitle)) != null) {
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0365R.C0367id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0365R.C0367id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0365R.C0367id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        if (this.mCustomTitleView != null) {
            ...
            View titleTemplate = this.mWindow.findViewById(C0365R.C0367id.title_template);
        ...
        if (hasTextTitle && this.mShowTitle) {
            TextView textView = (TextView) this.mWindow.findViewById(C0365R.C0367id.alertTitle);
        ...
        View titleTemplate2 = this.mWindow.findViewById(C0365R.C0367id.title_template);
    ...
    private void setupContent(ViewGroup contentPanel) {
        NestedScrollView nestedScrollView = (NestedScrollView) this.mWindow.findViewById(C0365R.C0367id.scrollView);
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray ta = context.obtainStyledAttributes(attrs, C0365R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = ta.getDimensionPixelOffset(C0365R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = ta.getDimensionPixelOffset(C0365R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
