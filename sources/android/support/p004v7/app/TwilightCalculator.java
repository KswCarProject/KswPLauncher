...
class TwilightCalculator {
    ...
    /* renamed from: C1 */
    private static final float f52C1 = 0.0334196f;

    /* renamed from: C2 */
    private static final float f53C2 = 3.49066E-4f;

    /* renamed from: C3 */
    private static final float f54C3 = 5.236E-6f;
    public static final int DAY = 0;
    private static final float DEGREES_TO_RADIANS = 0.017453292f;

    /* renamed from: J0 */
    private static final float f55J0 = 9.0E-4f;
    ...
    public void calculateTwilight(long time, double latitude, double longitude) {
        ...
        float n = (float) Math.round((daysSince2000 - f55J0) - arcLongitude);
        double trueAnomaly2 = meanAnomaly;
        double solarTransitJ2000 = f55J0 + n + arcLongitude + (Math.sin(trueAnomaly2) * 0.0053d) + (Math.sin(2.0d * solarLng) * (-0.0069d));
