...
public class SpoofChecker {
    ...
    public static class Builder {
        ...
        public SpoofChecker build() {
            ...
            result.fAllowedCharsSet.m87freeze();
        ...
        if (other instanceof SpoofChecker) {
            ...
            if ((spoofData == spoofData2 || spoofData == null || spoofData.equals(spoofData2)) && this.fChecks == otherSC.fChecks) {
                ...
                if (set == set2 || set == null || set.equals(set2)) {
                    ...
                    return (unicodeSet == unicodeSet2 || unicodeSet == null || unicodeSet.equals(unicodeSet2)) && this.fRestrictionLevel == otherSC.fRestrictionLevel;
                }
                return false;
            }
            return false;
        ...
        public boolean equals(Object other) {
            ...
            if (other instanceof SpoofData) {
                ...
                if (Arrays.equals(this.fCFUKeys, otherData.fCFUKeys) && Arrays.equals(this.fCFUValues, otherData.fCFUValues)) {
                    return Utility.sameObjects(this.fCFUStrings, otherData.fCFUStrings) || (str = this.fCFUStrings) == null || str.equals(otherData.fCFUStrings);
                }
                return false;
            }
            return false;
