...
public class AlsId7SubNaviViewBindingImpl extends AlsId7SubNaviViewBinding implements OnClickListener.Listener {
    ...
    public AlsId7SubNaviViewBindingImpl(@Nullable DataBindingComponent bindingComponent, @NonNull View root) {
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.naviImageView.setOnClickListener(this.mCallback180);
        }
    }
