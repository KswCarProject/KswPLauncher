...
public class Benz2021KswFragmentOneHdpi1280x720Impl extends Benz2021KswFragmentOne {
    ...
    static {
        ...
        sparseIntArray.put(C0899R.C0901id.car_rl, 23);
        sparseIntArray.put(C0899R.C0901id.car_tv, 24);
        sparseIntArray.put(C0899R.C0901id.car_tip, 25);
        sparseIntArray.put(C0899R.C0901id.iv_car1, 26);
        sparseIntArray.put(C0899R.C0901id.space, 27);
        sparseIntArray.put(C0899R.C0901id.iv_car2, 28);
