...
public class BenzMbuxWeatherCardBindingImpl extends BenzMbuxWeatherCardBinding implements OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        if ((4 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback342);
            this.mboundView2.setOnClickListener(this.mCallback343);
            this.mboundView3.setOnClickListener(this.mCallback344);
        }
    }
