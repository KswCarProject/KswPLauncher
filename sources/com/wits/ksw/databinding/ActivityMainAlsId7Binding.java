...
public abstract class ActivityMainAlsId7Binding extends ViewDataBinding {
    ...
    protected ActivityMainAlsId7Binding(Object _bindingComponent, View _root, int _localFieldCount, Guideline guideline2, ImageView imageView12, ImageView imageView32, ImageView imageView42, Button menuButton12, Button menuButton22, Button menuButton32, ConstraintLayout menuConstraintLayout2, ViewPager viewPage2) {
    ...
    public static ActivityMainAlsId7Binding inflate(LayoutInflater inflater, Object component) {
        return (ActivityMainAlsId7Binding) ViewDataBinding.inflateInternal(inflater, R.layout.activity_main_als_id7, (ViewGroup) null, false, component);
    }
