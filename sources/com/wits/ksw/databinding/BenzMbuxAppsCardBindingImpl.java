...
public class BenzMbuxAppsCardBindingImpl extends BenzMbuxAppsCardBinding implements OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        if ((4 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback352);
            this.mboundView2.setOnClickListener(this.mCallback353);
            this.mboundView3.setOnClickListener(this.mCallback354);
        }
    }
