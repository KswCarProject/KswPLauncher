...
public class BenzMbuxVideoCardBindingHdpi1920x720Impl extends BenzMbuxVideoCardBinding implements OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 7) != 0) {
            ...
            viewModelItemIconClassicalBenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeVideoSelector1BenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeVideoSelector2 = AppCompatResources.getDrawable(this.benzMbuxLocalCardBg.getContext(), viewModelItemIconClassicalGet ? C0899R.C0900drawable.benz_mbux_2021_ksw_home_video_selector1 : C0899R.C0900drawable.benz_mbux_2021_ksw_home_video_selector2);
        }
        if ((7 & dirtyFlags) != 0) {
        ...
        if ((4 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback67);
