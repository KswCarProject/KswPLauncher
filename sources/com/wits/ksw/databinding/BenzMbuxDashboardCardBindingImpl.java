...
public class BenzMbuxDashboardCardBindingImpl extends BenzMbuxDashboardCardBinding implements OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        if ((4 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback489);
            this.mboundView2.setOnClickListener(this.mCallback490);
            this.mboundView3.setOnClickListener(this.mCallback491);
        }
    }
