...
public abstract class BenzMbuxWeatherCardBinding extends ViewDataBinding {
    ...
    protected BenzMbuxWeatherCardBinding(Object _bindingComponent, View _root, int _localFieldCount, AppCompatImageView benzMbuxLocalCardBg, AppCompatTextView benzMbuxLocalCardContent, AppCompatTextView benzMbuxLocalCardTitle) {
    ...
    public static BenzMbuxWeatherCardBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot, Object component) {
        return (BenzMbuxWeatherCardBinding) ViewDataBinding.inflateInternal(inflater, C0899R.C0902layout.benz_mbux_weather_card, root, attachToRoot, component);
    }
    ...
    public static BenzMbuxWeatherCardBinding inflate(LayoutInflater inflater, Object component) {
        return (BenzMbuxWeatherCardBinding) ViewDataBinding.inflateInternal(inflater, C0899R.C0902layout.benz_mbux_weather_card, null, false, component);
    }
    ...
    public static BenzMbuxWeatherCardBinding bind(View view, Object component) {
        return (BenzMbuxWeatherCardBinding) bind(component, view, C0899R.C0902layout.benz_mbux_weather_card);
    }
}
