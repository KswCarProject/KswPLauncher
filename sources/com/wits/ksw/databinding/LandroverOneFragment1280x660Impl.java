...
public class LandroverOneFragment1280x660Impl extends LandroverOneFragment implements OnClickListener.Listener {
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.landroverMainIconCar.setOnClickListener(this.mCallback79);
            this.landroverMainIconDvr.setOnClickListener(this.mCallback80);
            this.landroverMainIconGps.setOnClickListener(this.mCallback76);
            this.landroverMainIconMusic.setOnClickListener(this.mCallback78);
            this.landroverMainIconSettings.setOnClickListener(this.mCallback81);
            this.landroverMainIconVideo.setOnClickListener(this.mCallback77);
        }
        if ((3 & dirtyFlags) != 0) {
