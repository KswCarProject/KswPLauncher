...
public class AudiRightLogoBindingSw600dpLandImpl extends AudiRightLogoBinding {
    ...
    private AudiRightLogoBindingSw600dpLandImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public void executeBindings() {
        ...
        if ((7 & dirtyFlags) != 0) {
            ((ConstraintLayout) this.KSWA4LRightShowLogo).setVisibility(vmLogoViewGet);
        }
    }
}
