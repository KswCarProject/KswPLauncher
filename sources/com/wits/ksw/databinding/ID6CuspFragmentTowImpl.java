...
public class ID6CuspFragmentTowImpl extends ID6CuspFragmentTow {
    ...
    static {
        ...
        sparseIntArray.put(C0899R.C0901id.id6_cusp_video_iamge_view, 1);
        sparseIntArray.put(C0899R.C0901id.id6_cusp_video_mess, 2);
        sparseIntArray.put(C0899R.C0901id.id6_cusp_car_image_view, 3);
        sparseIntArray.put(C0899R.C0901id.id6_cusp_car_text_view, 4);
        sparseIntArray.put(C0899R.C0901id.id6_cusp_car_mess, 5);
        sparseIntArray.put(C0899R.C0901id.id6_cusp_browser_image_view, 6);
        sparseIntArray.put(C0899R.C0901id.id6_cusp_browser_text_view, 7);
        sparseIntArray.put(C0899R.C0901id.id6_cusp_browser_mess, 8);
    }
