...
public abstract class BmwId8PempModusLayoutBinding extends ViewDataBinding {
    ...
    protected BmwId8PempModusLayoutBinding(Object _bindingComponent, View _root, int _localFieldCount, Id8PempLauncherLeftBarBinding bmwId8PempModusMainLeftBar, RelativeLayout llModusEfficient, ImageView llModusEfficientImg, RelativeLayout llModusPersonal, ImageView llModusPersonalImg, RelativeLayout llModusSport, ImageView llModusSportImg, RelativeLayout rlModusContainer, TextView tvChangeModusTitle) {
        super(_bindingComponent, _root, _localFieldCount);
        this.bmwId8PempModusMainLeftBar = bmwId8PempModusMainLeftBar;
    ...
    public static BmwId8PempModusLayoutBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot, Object component) {
        return (BmwId8PempModusLayoutBinding) ViewDataBinding.inflateInternal(inflater, C0899R.C0902layout.activity_id8_pemp_modus_layout, root, attachToRoot, component);
    }
    ...
    public static BmwId8PempModusLayoutBinding inflate(LayoutInflater inflater, Object component) {
        return (BmwId8PempModusLayoutBinding) ViewDataBinding.inflateInternal(inflater, C0899R.C0902layout.activity_id8_pemp_modus_layout, null, false, component);
    }
    ...
    public static BmwId8PempModusLayoutBinding bind(View view, Object component) {
        return (BmwId8PempModusLayoutBinding) bind(component, view, C0899R.C0902layout.activity_id8_pemp_modus_layout);
    }
}
