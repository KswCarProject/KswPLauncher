...
public class MainActivitySw600dpLandImpl extends MainActivity implements OnClickListener.Listener {
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.menuButton1.setOnClickListener(this.mCallback187);
            this.menuButton2.setOnClickListener(this.mCallback186);
            this.menuButton3.setOnClickListener(this.mCallback185);
            this.menuButton4.setOnClickListener(this.mCallback188);
            this.menuButton5.setOnClickListener(this.mCallback189);
        }
    }
