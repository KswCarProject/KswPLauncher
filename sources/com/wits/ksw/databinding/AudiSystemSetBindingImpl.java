...
public class AudiSystemSetBindingImpl extends AudiSystemSetBinding {
    ...
    private AudiSystemSetBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 6, bindings[6], bindings[11], bindings[2], bindings[10], bindings[1], bindings[5], bindings[4], bindings[3], bindings[7], bindings[8], bindings[9], bindings[12], bindings[13]);
        this.mDirtyFlags = -1;
