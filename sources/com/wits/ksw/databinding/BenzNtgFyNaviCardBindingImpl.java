...
public class BenzNtgFyNaviCardBindingImpl extends BenzNtgFyNaviCardBinding implements OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback512);
            this.mboundView2.setOnClickListener(this.mCallback513);
            this.mboundView3.setOnClickListener(this.mCallback514);
        }
    }
