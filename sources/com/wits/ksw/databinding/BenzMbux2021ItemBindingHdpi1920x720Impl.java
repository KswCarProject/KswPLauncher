...
public class BenzMbux2021ItemBindingHdpi1920x720Impl extends BenzMbux2021ItemBinding implements OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        if ((4 & dirtyFlags) != 0) {
            this.benzMbux2021ImageView.setOnClickListener(this.mCallback473);
            this.benzMbux2021Tip.setOnClickListener(this.mCallback474);
            this.mboundView4.setOnClickListener(this.mCallback475);
            this.mboundView5.setOnClickListener(this.mCallback476);
        }
        if ((5 & dirtyFlags) != 0) {
