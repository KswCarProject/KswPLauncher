...
public class BenzMbuxAppsCardBindingHdpi1920x720Impl extends BenzMbuxAppsCardBinding implements OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 7) != 0) {
            ...
            viewModelItemIconClassicalBenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeAppSelector1BenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeAppSelector2 = AppCompatResources.getDrawable(this.benzMbuxLocalCardBg.getContext(), viewModelItemIconClassicalGet ? C0899R.C0900drawable.benz_mbux_2021_ksw_home_app_selector1 : C0899R.C0900drawable.benz_mbux_2021_ksw_home_app_selector2);
        }
        if ((7 & dirtyFlags) != 0) {
        ...
        if ((4 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback496);
            this.mboundView2.setOnClickListener(this.mCallback497);
            this.mboundView3.setOnClickListener(this.mCallback498);
        }
    }
