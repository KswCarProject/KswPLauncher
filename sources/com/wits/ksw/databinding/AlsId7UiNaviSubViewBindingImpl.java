...
public class AlsId7UiNaviSubViewBindingImpl extends AlsId7UiNaviSubViewBinding implements OnClickListener.Listener {
    ...
    public AlsId7UiNaviSubViewBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }

    private AlsId7UiNaviSubViewBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.naviImageView.setOnClickListener(this.mCallback2);
        }
    }
