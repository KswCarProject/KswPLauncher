...
public class BenzMbux2021ItemBinding1024x600Impl extends BenzMbux2021ItemBinding implements OnClickListener.Listener {
    ...
    private BenzMbux2021ItemBinding1024x600Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        this.mCallback511 = new OnClickListener(this, 4);
        this.mCallback510 = new OnClickListener(this, 3);
    ...
    protected void executeBindings() {
        ...
        if ((4 & dirtyFlags) != 0) {
            this.benzMbux2021ImageView.setOnClickListener(this.mCallback508);
            this.benzMbux2021Tip.setOnClickListener(this.mCallback509);
            this.mboundView4.setOnClickListener(this.mCallback510);
            this.mboundView5.setOnClickListener(this.mCallback511);
        }
        if ((5 & dirtyFlags) != 0) {
