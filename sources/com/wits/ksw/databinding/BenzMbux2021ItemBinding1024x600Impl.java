...
public class BenzMbux2021ItemBinding1024x600Impl extends BenzMbux2021ItemBinding implements OnClickListener.Listener {
    ...
    public void executeBindings() {
        ...
        if ((4 & dirtyFlags) != 0) {
            this.benzMbux2021ImageView.setOnClickListener(this.mCallback247);
            this.benzMbux2021Tip.setOnClickListener(this.mCallback248);
            this.mboundView4.setOnClickListener(this.mCallback249);
            this.mboundView5.setOnClickListener(this.mCallback250);
        }
        if ((5 & dirtyFlags) != 0) {
