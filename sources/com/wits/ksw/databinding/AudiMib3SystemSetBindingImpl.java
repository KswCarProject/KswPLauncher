...
public class AudiMib3SystemSetBindingImpl extends AudiMib3SystemSetBinding {
    ...
    private AudiMib3SystemSetBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 6, bindings[6], bindings[14], bindings[2], bindings[13], bindings[1], bindings[5], bindings[4], bindings[3], bindings[10], bindings[11], bindings[12], bindings[9], bindings[7], bindings[8], bindings[15]);
        this.mDirtyFlags = -1;
