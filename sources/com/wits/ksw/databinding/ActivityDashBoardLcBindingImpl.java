...
public class ActivityDashBoardLcBindingImpl extends ActivityDashBoardLcBinding {
    ...
    static {
        sViewsWithIds.put(R.id.audi_lc_dashboard_speed_highlight_ImageView, 13);
        sViewsWithIds.put(R.id.tachometerImageView, 14);
        sViewsWithIds.put(R.id.audi_lc_dashboard_tachometer_highlight_imageView, 15);
    }

    public ActivityDashBoardLcBindingImpl(@Nullable DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 16, sIncludes, sViewsWithIds));
    }

    private ActivityDashBoardLcBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 12, bindings[13], bindings[15], bindings[11], bindings[5], bindings[10], bindings[6], bindings[7], bindings[8], bindings[9], bindings[0], bindings[12], bindings[3], bindings[2], bindings[14], bindings[1], bindings[4]);
        this.mDirtyFlags = -1;
    ...
    public void executeBindings() {
        ...
        L_0x03fa:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.wits.ksw.databinding.ActivityDashBoardLcBindingImpl.executeBindings():void");
    }
}
