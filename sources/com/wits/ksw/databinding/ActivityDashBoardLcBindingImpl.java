...
public class ActivityDashBoardLcBindingImpl extends ActivityDashBoardLcBinding {
    ...
    static {
        ...
        sparseIntArray.put(C0899R.C0901id.audi_lc_dashboard_speed_highlight_ImageView, 13);
        sparseIntArray.put(C0899R.C0901id.tachometerImageView, 14);
        sparseIntArray.put(C0899R.C0901id.audi_lc_dashboard_tachometer_highlight_imageView, 15);
    }
