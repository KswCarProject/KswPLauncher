...
public class BenzNtgFyVideoCardBindingImpl extends BenzNtgFyVideoCardBinding implements OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback411);
            this.mboundView2.setOnClickListener(this.mCallback412);
            this.mboundView3.setOnClickListener(this.mCallback413);
        }
    }
