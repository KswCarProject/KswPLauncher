...
public class Benz2021KswV2FragmentTwoImpl extends Benz2021KswV2FragmentTwo {
    ...
    static {
        ...
        sparseIntArray.put(R.id.car_tv, 19);
        sparseIntArray.put(R.id.car_tip, 20);
        sparseIntArray.put(R.id.iv_car1, 21);
        sparseIntArray.put(R.id.space4, 22);
        sparseIntArray.put(R.id.iv_car2, 23);
    ...
    private Benz2021KswV2FragmentTwoImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1, bindings[2], bindings[12], bindings[14], bindings[13], bindings[8], bindings[3], bindings[18], bindings[20], bindings[19], bindings[4], bindings[24], bindings[26], bindings[25], bindings[5], bindings[30], bindings[32], bindings[31], bindings[0], bindings[15], bindings[17], bindings[21], bindings[23], bindings[27], bindings[29], bindings[33], bindings[35], bindings[9], bindings[11], bindings[28], bindings[10], bindings[16], bindings[22], bindings[34], bindings[1], bindings[6], bindings[7]);
        this.mDirtyFlags = -1;
