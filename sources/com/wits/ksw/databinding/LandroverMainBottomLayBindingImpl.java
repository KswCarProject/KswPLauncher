...
public class LandroverMainBottomLayBindingImpl extends LandroverMainBottomLayBinding implements OnClickListener.Listener {
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.landroverMainBottomAirBtn.setOnClickListener(this.mCallback227);
            this.landroverMainBottomBtBtn.setOnClickListener(this.mCallback225);
            this.landroverMainBottomDvrBtn.setOnClickListener(this.mCallback223);
            this.landroverMainBottomGpsBtn.setOnClickListener(this.mCallback224);
            this.landroverMainBottomMenuBtn.setOnClickListener(this.mCallback221);
            this.landroverMainBottomOffBtn.setOnClickListener(this.mCallback230);
            this.landroverMainBottomParkassistBtn.setOnClickListener(this.mCallback229);
            this.landroverMainBottomRadarBtn.setOnClickListener(this.mCallback228);
            this.landroverMainBottomReturnBtn.setOnClickListener(this.mCallback220);
            this.landroverMainBottomSetupBtn.setOnClickListener(this.mCallback222);
            this.landroverMainBottomVideoBtn.setOnClickListener(this.mCallback226);
        }
    }
