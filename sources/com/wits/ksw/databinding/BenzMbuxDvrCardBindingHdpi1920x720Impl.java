...
public class BenzMbuxDvrCardBindingHdpi1920x720Impl extends BenzMbuxDvrCardBinding implements OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        if ((4 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback212);
            this.mboundView2.setOnClickListener(this.mCallback213);
            this.mboundView3.setOnClickListener(this.mCallback214);
        }
    }
