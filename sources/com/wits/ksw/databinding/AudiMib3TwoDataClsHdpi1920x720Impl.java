...
public class AudiMib3TwoDataClsHdpi1920x720Impl extends AudiMib3TwoDataCls {
    ...
    private AudiMib3TwoDataClsHdpi1920x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0, bindings[10], bindings[11], bindings[12], bindings[4], bindings[5], bindings[6], bindings[1], bindings[2], bindings[3], bindings[7], bindings[8], bindings[9], bindings[0]);
        this.mDirtyFlags = -1;
