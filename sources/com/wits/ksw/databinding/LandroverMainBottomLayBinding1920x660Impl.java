...
public class LandroverMainBottomLayBinding1920x660Impl extends LandroverMainBottomLayBinding implements OnClickListener.Listener {
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.landroverMainBottomAirBtn.setOnClickListener(this.mCallback60);
            this.landroverMainBottomBtBtn.setOnClickListener(this.mCallback58);
            this.landroverMainBottomDvrBtn.setOnClickListener(this.mCallback56);
            this.landroverMainBottomGpsBtn.setOnClickListener(this.mCallback57);
            this.landroverMainBottomMenuBtn.setOnClickListener(this.mCallback54);
            this.landroverMainBottomOffBtn.setOnClickListener(this.mCallback63);
            this.landroverMainBottomParkassistBtn.setOnClickListener(this.mCallback62);
            this.landroverMainBottomRadarBtn.setOnClickListener(this.mCallback61);
            this.landroverMainBottomReturnBtn.setOnClickListener(this.mCallback53);
            this.landroverMainBottomSetupBtn.setOnClickListener(this.mCallback55);
            this.landroverMainBottomVideoBtn.setOnClickListener(this.mCallback59);
        }
    }
