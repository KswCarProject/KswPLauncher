...
public class BenzMbuxZlinkCardBindingImpl extends BenzMbuxZlinkCardBinding implements OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 7) != 0) {
            ...
            viewModelItemIconClassicalBenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeEasySelector1BenzMbuxLocalCardBgAndroidDrawableBenzMbux2021KswHomeEasySelector2 = AppCompatResources.getDrawable(this.benzMbuxLocalCardBg.getContext(), viewModelItemIconClassicalGet ? C0899R.C0900drawable.benz_mbux_2021_ksw_home_easy_selector1 : C0899R.C0900drawable.benz_mbux_2021_ksw_home_easy_selector2);
        }
        if ((7 & dirtyFlags) != 0) {
        ...
        if ((4 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback368);
            this.mboundView2.setOnClickListener(this.mCallback369);
            this.mboundView3.setOnClickListener(this.mCallback370);
        }
    }
