...
public class BmwId8PempModusLayoutBindingImpl extends BmwId8PempModusLayoutBinding implements OnClickListener.Listener {
    ...
    static {
        ...
        includedLayouts.setIncludes(0, new String[]{"id8_pemp_launcher_left_bar"}, new int[]{10}, new int[]{C0899R.C0902layout.id8_pemp_launcher_left_bar});
    ...
    public boolean hasPendingBindings() {
        synchronized (this) {
            ...
            return this.bmwId8PempModusMainLeftBar.hasPendingBindings();
        }
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 32) != 0) {
            this.llModusEfficientImg.setOnClickListener(this.mCallback367);
            this.llModusPersonalImg.setOnClickListener(this.mCallback365);
            this.llModusSportImg.setOnClickListener(this.mCallback366);
        }
        if ((dirtyFlags & 52) != 0) {
