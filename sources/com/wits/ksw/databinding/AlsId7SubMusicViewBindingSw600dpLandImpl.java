...
public class AlsId7SubMusicViewBindingSw600dpLandImpl extends AlsId7SubMusicViewBinding implements OnClickListener.Listener {
    ...
    public void executeBindings() {
        ...
        if ((dirtyFlags & PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID) != 0) {
            ...
            this.btnMusicNext.setOnClickListener(this.mCallback44);
            this.btnMusicPause.setOnClickListener(this.mCallback43);
            this.btnMusicPrev.setOnClickListener(this.mCallback42);
            this.imageFrameLayout.setOnClickListener(this.mCallback41);
        }
        if ((dirtyFlags & 1025) != 0) {
