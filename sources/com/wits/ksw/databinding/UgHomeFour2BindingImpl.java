...
public class UgHomeFour2BindingImpl extends UgHomeFour2Binding implements OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.ugHomeBrowserVaiw.setOnClickListener(this.mCallback327);
            this.ugHomeDvrVaiw.setOnClickListener(this.mCallback328);
            this.ugHomeFileVaiw.setOnClickListener(this.mCallback329);
        }
    }
