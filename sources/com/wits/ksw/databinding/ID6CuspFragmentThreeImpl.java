...
public class ID6CuspFragmentThreeImpl extends ID6CuspFragmentThree {
    ...
    static {
        ...
        sparseIntArray.put(C0899R.C0901id.id6_cusp_file_iamge_view, 3);
        sparseIntArray.put(C0899R.C0901id.id6_cusp_video_mess, 4);
        sparseIntArray.put(C0899R.C0901id.id6_cusp_dvr_image_view, 5);
        sparseIntArray.put(C0899R.C0901id.id6_cusp_dvr_mess, 6);
        sparseIntArray.put(C0899R.C0901id.id6_cusp_dashboard_image_view, 7);
    }
