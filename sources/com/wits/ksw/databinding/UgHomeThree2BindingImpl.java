...
public class UgHomeThree2BindingImpl extends UgHomeThree2Binding implements OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.ugHomeCarVaiw.setOnClickListener(this.mCallback205);
            this.ugHomeDashboradVaiw.setOnClickListener(this.mCallback206);
            this.ugHomeSettingVaiw.setOnClickListener(this.mCallback207);
        }
    }
