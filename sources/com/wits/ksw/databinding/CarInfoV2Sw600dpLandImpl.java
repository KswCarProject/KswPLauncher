...
public class CarInfoV2Sw600dpLandImpl extends CarInfoV2 {
    ...
    static {
        ...
        includedLayouts.setIncludes(0, new String[]{"id7_sub_video_view", "id7_sub_dashboard_view"}, new int[]{1, 2}, new int[]{C0899R.C0902layout.id7_sub_video_view, C0899R.C0902layout.id7_sub_dashboard_view});
        sViewsWithIds = null;
    }
