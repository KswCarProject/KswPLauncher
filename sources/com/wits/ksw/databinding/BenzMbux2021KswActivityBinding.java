...
public abstract class BenzMbux2021KswActivityBinding extends ViewDataBinding {
    ...
    public static BenzMbux2021KswActivityBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot, Object component) {
        return (BenzMbux2021KswActivityBinding) ViewDataBinding.inflateInternal(inflater, C0899R.C0902layout.activity_main_benz_mbux_2021_ksw, root, attachToRoot, component);
    }
    ...
    public static BenzMbux2021KswActivityBinding inflate(LayoutInflater inflater, Object component) {
        return (BenzMbux2021KswActivityBinding) ViewDataBinding.inflateInternal(inflater, C0899R.C0902layout.activity_main_benz_mbux_2021_ksw, null, false, component);
    }
    ...
    public static BenzMbux2021KswActivityBinding bind(View view, Object component) {
        return (BenzMbux2021KswActivityBinding) bind(component, view, C0899R.C0902layout.activity_main_benz_mbux_2021_ksw);
    }
}
