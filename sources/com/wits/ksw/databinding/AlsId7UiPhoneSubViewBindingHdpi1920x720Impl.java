...
public class AlsId7UiPhoneSubViewBindingHdpi1920x720Impl extends AlsId7UiPhoneSubViewBinding implements OnClickListener.Listener {
    ...
    public AlsId7UiPhoneSubViewBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private AlsId7UiPhoneSubViewBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public void executeBindings() {
        ...
        if ((dirtyFlags & 16) != 0) {
            this.phoneImageView.setOnClickListener(this.mCallback27);
        }
        if ((dirtyFlags & 24) != 0) {
