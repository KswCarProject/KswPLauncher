...
public abstract class Id8PempLauncherLeftBarBinding extends ViewDataBinding {
    ...
    public static Id8PempLauncherLeftBarBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot, Object component) {
        return (Id8PempLauncherLeftBarBinding) ViewDataBinding.inflateInternal(inflater, C0899R.C0902layout.id8_pemp_launcher_left_bar, root, attachToRoot, component);
    }
    ...
    public static Id8PempLauncherLeftBarBinding inflate(LayoutInflater inflater, Object component) {
        return (Id8PempLauncherLeftBarBinding) ViewDataBinding.inflateInternal(inflater, C0899R.C0902layout.id8_pemp_launcher_left_bar, null, false, component);
    }
    ...
    public static Id8PempLauncherLeftBarBinding bind(View view, Object component) {
        return (Id8PempLauncherLeftBarBinding) bind(component, view, C0899R.C0902layout.id8_pemp_launcher_left_bar);
    }
}
