...
public class UgHomeFourBindingImpl extends UgHomeFourBinding implements OnClickListener.Listener {
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.ugHomeBrowserVaiw.setOnClickListener(this.mCallback138);
            this.ugHomeDvrVaiw.setOnClickListener(this.mCallback139);
            this.ugHomeFileVaiw.setOnClickListener(this.mCallback140);
        }
    }
