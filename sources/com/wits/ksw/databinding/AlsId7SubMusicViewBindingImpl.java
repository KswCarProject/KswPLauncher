...
public class AlsId7SubMusicViewBindingImpl extends AlsId7SubMusicViewBinding implements OnClickListener.Listener {
    ...
    public void executeBindings() {
        ...
        if ((dirtyFlags & PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID) != 0) {
            ...
            this.btnMusicNext.setOnClickListener(this.mCallback183);
            this.btnMusicPause.setOnClickListener(this.mCallback182);
            this.btnMusicPrev.setOnClickListener(this.mCallback181);
            this.imageFrameLayout.setOnClickListener(this.mCallback180);
        }
        if ((dirtyFlags & 1025) != 0) {
