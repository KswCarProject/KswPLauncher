...
public class AlsId7SubMusicViewBindingImpl extends AlsId7SubMusicViewBinding implements OnClickListener.Listener {
    ...
    public AlsId7SubMusicViewBindingImpl(@Nullable DataBindingComponent bindingComponent, @NonNull View root) {
    ...
    public void executeBindings() {
        ...
        if ((dirtyFlags & PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID) != 0) {
            ...
            this.btnMusicNext.setOnClickListener(this.mCallback149);
            this.btnMusicPause.setOnClickListener(this.mCallback148);
            this.btnMusicPrev.setOnClickListener(this.mCallback147);
            this.imageFrameLayout.setOnClickListener(this.mCallback146);
        }
        if ((dirtyFlags & 1056) != 0) {
