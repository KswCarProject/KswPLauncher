...
public class ActivityMainAlsId7V2BindingImpl extends ActivityMainAlsId7V2Binding {
    ...
    static {
        ...
        sparseIntArray.put(C0899R.C0901id.imageView3, 11);
        sparseIntArray.put(C0899R.C0901id.viewPage, 12);
        sparseIntArray.put(C0899R.C0901id.ll_left, 13);
        sparseIntArray.put(C0899R.C0901id.btn_apps, 14);
        sparseIntArray.put(C0899R.C0901id.btn_settings, 15);
        sparseIntArray.put(C0899R.C0901id.btn_shut_1, 16);
        sparseIntArray.put(C0899R.C0901id.btn_shut_2, 17);
        sparseIntArray.put(C0899R.C0901id.btn_shut_3, 18);
    }
