...
public class ActivityMainAlsId7V2BindingImpl extends ActivityMainAlsId7V2Binding {
    ...
    private ActivityMainAlsId7V2BindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 6, bindings[14], bindings[15], bindings[16], bindings[17], bindings[18], bindings[7], bindings[8], bindings[11], bindings[9], bindings[10], bindings[13], bindings[12]);
        this.mDirtyFlags = -1;
