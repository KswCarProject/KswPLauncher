...
public class Benz2021KswV2FragmentOneHdpi1280x720Impl extends Benz2021KswV2FragmentOne {
    ...
    static {
        ...
        sparseIntArray.put(C0899R.C0901id.iv_navi2, 14);
        sparseIntArray.put(C0899R.C0901id.music_rl, 15);
        sparseIntArray.put(C0899R.C0901id.music_tv, 16);
        sparseIntArray.put(C0899R.C0901id.iv_music1, 17);
        sparseIntArray.put(C0899R.C0901id.iv_music2, 18);
        sparseIntArray.put(C0899R.C0901id.bt_rl, 19);
        sparseIntArray.put(C0899R.C0901id.bt_tv, 20);
        sparseIntArray.put(C0899R.C0901id.iv_bt1, 21);
        sparseIntArray.put(C0899R.C0901id.iv_bt2, 22);
        sparseIntArray.put(C0899R.C0901id.weather_rl, 23);
        sparseIntArray.put(C0899R.C0901id.weather_tv, 24);
        sparseIntArray.put(C0899R.C0901id.weather_tip, 25);
        sparseIntArray.put(C0899R.C0901id.iv_weather1, 26);
        sparseIntArray.put(C0899R.C0901id.space4, 27);
        sparseIntArray.put(C0899R.C0901id.iv_weather2, 28);
        sparseIntArray.put(C0899R.C0901id.setting_rl, 29);
        sparseIntArray.put(C0899R.C0901id.set_tv, 30);
        sparseIntArray.put(C0899R.C0901id.set_tip, 31);
        sparseIntArray.put(C0899R.C0901id.iv_set1, 32);
        sparseIntArray.put(C0899R.C0901id.space5, 33);
        sparseIntArray.put(C0899R.C0901id.iv_set2, 34);
    }
