...
public class Id7SubDashboardViewBindingSw600dpLandImpl extends Id7SubDashboardViewBinding implements OnClickListener.Listener {
    ...
    public Id7SubDashboardViewBindingSw600dpLandImpl(@Nullable DataBindingComponent bindingComponent, @NonNull View root) {
    ...
    public void executeBindings() {
        ...
        if ((dirtyFlags & 128) != 0) {
            ...
            this.dashboardImageView.setOnClickListener(this.mCallback106);
        }
        if ((dirtyFlags & 132) != 0) {
