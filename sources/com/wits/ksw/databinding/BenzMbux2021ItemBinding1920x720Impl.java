...
public class BenzMbux2021ItemBinding1920x720Impl extends BenzMbux2021ItemBinding implements OnClickListener.Listener {
    ...
    public BenzMbux2021ItemBinding1920x720Impl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }

    private BenzMbux2021ItemBinding1920x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public void executeBindings() {
        ...
        if ((4 & dirtyFlags) != 0) {
            this.benzMbux2021ImageView.setOnClickListener(this.mCallback155);
            this.benzMbux2021Tip.setOnClickListener(this.mCallback156);
