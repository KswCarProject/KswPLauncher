...
public class BenzNtg6FyFragmentOneClsV21024x600Impl extends BenzNtg6FyFragmentOneClsV2 {
    ...
    static {
        ...
        sparseIntArray.put(C0899R.C0901id.weather_rl, 22);
        sparseIntArray.put(C0899R.C0901id.weather_itemview, 23);
        sparseIntArray.put(C0899R.C0901id.weather_tv, 24);
        sparseIntArray.put(C0899R.C0901id.weather_tip, 25);
        sparseIntArray.put(C0899R.C0901id.weather_iv1, 26);
        sparseIntArray.put(C0899R.C0901id.space4, 27);
        sparseIntArray.put(C0899R.C0901id.weather_iv2, 28);
        sparseIntArray.put(C0899R.C0901id.car_rl, 29);
        sparseIntArray.put(C0899R.C0901id.car_itemview, 30);
        sparseIntArray.put(C0899R.C0901id.car_tv, 31);
        sparseIntArray.put(C0899R.C0901id.car_tip, 32);
        sparseIntArray.put(C0899R.C0901id.car_iv1, 33);
        sparseIntArray.put(C0899R.C0901id.space5, 34);
        sparseIntArray.put(C0899R.C0901id.car_iv2, 35);
    }
