...
public class LandroverOneFragment1920x660Impl extends LandroverOneFragment implements OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.landroverMainIconCar.setOnClickListener(this.mCallback482);
            this.landroverMainIconDvr.setOnClickListener(this.mCallback483);
            this.landroverMainIconGps.setOnClickListener(this.mCallback479);
            this.landroverMainIconMusic.setOnClickListener(this.mCallback481);
            this.landroverMainIconSettings.setOnClickListener(this.mCallback484);
            this.landroverMainIconVideo.setOnClickListener(this.mCallback480);
        }
        if ((3 & dirtyFlags) != 0) {
