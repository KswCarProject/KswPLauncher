...
public class LandroverOneFragment1920x660Impl extends LandroverOneFragment implements OnClickListener.Listener {
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.landroverMainIconCar.setOnClickListener(this.mCallback337);
            this.landroverMainIconDvr.setOnClickListener(this.mCallback338);
            this.landroverMainIconGps.setOnClickListener(this.mCallback334);
            this.landroverMainIconMusic.setOnClickListener(this.mCallback336);
            this.landroverMainIconSettings.setOnClickListener(this.mCallback339);
            this.landroverMainIconVideo.setOnClickListener(this.mCallback335);
        }
        if ((3 & dirtyFlags) != 0) {
