...
public class MediaFragmentBindingV2Impl extends MediaFragmentBindingV2 {
    ...
    static {
        ...
        includedLayouts.setIncludes(0, new String[]{"id7_v2_sub_music_view", "id7_v2_sub_phone_view"}, new int[]{1, 2}, new int[]{C0899R.C0902layout.id7_v2_sub_music_view, C0899R.C0902layout.id7_v2_sub_phone_view});
        sViewsWithIds = null;
    }
