...
public class UgHomeThreeBindingImpl extends UgHomeThreeBinding implements OnClickListener.Listener {
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.ugHomeCarVaiw.setOnClickListener(this.mCallback89);
            this.ugHomeDashboradVaiw.setOnClickListener(this.mCallback90);
            this.ugHomeSettingVaiw.setOnClickListener(this.mCallback91);
        }
    }
