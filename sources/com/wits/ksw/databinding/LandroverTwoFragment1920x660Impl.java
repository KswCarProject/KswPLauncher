...
public class LandroverTwoFragment1920x660Impl extends LandroverTwoFragment implements OnClickListener.Listener {
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.landroverMainIconApp.setOnClickListener(this.mCallback108);
            this.landroverMainIconBrowser.setOnClickListener(this.mCallback109);
            this.landroverMainIconBt.setOnClickListener(this.mCallback104);
            this.landroverMainIconDashboard.setOnClickListener(this.mCallback106);
            this.landroverMainIconFile.setOnClickListener(this.mCallback105);
            this.landroverMainIconPhonelink.setOnClickListener(this.mCallback107);
        }
        if ((3 & dirtyFlags) != 0) {
