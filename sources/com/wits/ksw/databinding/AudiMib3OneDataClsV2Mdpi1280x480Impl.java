...
public class AudiMib3OneDataClsV2Mdpi1280x480Impl extends AudiMib3OneDataClsV2 {
    ...
    private AudiMib3OneDataClsV2Mdpi1280x480Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0, bindings[7], bindings[8], bindings[9], bindings[16], bindings[17], bindings[18], bindings[0], bindings[4], bindings[5], bindings[6], bindings[10], bindings[11], bindings[12], bindings[13], bindings[14], bindings[15], bindings[22], bindings[23], bindings[24], bindings[1], bindings[2], bindings[3], bindings[19], bindings[20], bindings[21]);
        this.mDirtyFlags = -1;
