...
public class ActivityMainAlsId6BindingImpl extends ActivityMainAlsId6Binding implements OnClickListener.Listener {
    ...
    public void executeBindings() {
        ...
        if ((dirtyFlags2 & PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID) != 0) {
            ...
            this.appLl.setOnClickListener(this.mCallback218);
            this.dashbroadLl.setOnClickListener(this.mCallback216);
            ...
            this.musicLl.setOnClickListener(this.mCallback217);
            this.naviLl.setOnClickListener(this.mCallback213);
            this.phoneLl.setOnClickListener(this.mCallback215);
            this.videoLl.setOnClickListener(this.mCallback214);
        }
