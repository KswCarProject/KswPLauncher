...
public class BenzNtg6FyFragmentOneClsV2Hdpi1920x720Impl extends BenzNtg6FyFragmentOneClsV2 {
    ...
    private BenzNtg6FyFragmentOneClsV2Hdpi1920x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 2, bindings[17], bindings[19], bindings[21], bindings[16], bindings[2], bindings[18], bindings[30], bindings[33], bindings[35], bindings[29], bindings[32], bindings[31], bindings[0], bindings[11], bindings[15], bindings[13], bindings[10], bindings[1], bindings[12], bindings[4], bindings[7], bindings[9], bindings[3], bindings[6], bindings[5], bindings[8], bindings[14], bindings[20], bindings[27], bindings[34], bindings[23], bindings[26], bindings[28], bindings[22], bindings[25], bindings[24]);
        this.mDirtyFlags = -1;
    ...
    public void executeBindings() {
        ...
        L_0x0096:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.wits.ksw.databinding.BenzNtg6FyFragmentOneClsV2Hdpi1920x720Impl.executeBindings():void");
    }
}
