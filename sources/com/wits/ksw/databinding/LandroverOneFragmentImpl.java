...
public class LandroverOneFragmentImpl extends LandroverOneFragment implements OnClickListener.Listener {
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.landroverMainIconCar.setOnClickListener(this.mCallback244);
            this.landroverMainIconDvr.setOnClickListener(this.mCallback245);
            this.landroverMainIconGps.setOnClickListener(this.mCallback241);
            this.landroverMainIconMusic.setOnClickListener(this.mCallback243);
            this.landroverMainIconSettings.setOnClickListener(this.mCallback246);
            this.landroverMainIconVideo.setOnClickListener(this.mCallback242);
        }
        if ((3 & dirtyFlags) != 0) {
