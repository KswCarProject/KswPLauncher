...
public class BenzMbuxMusicCardBindingHdpi1920x720Impl extends BenzMbuxMusicCardBinding implements OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 16) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback454);
            this.benzMbuxLocalMusicCardBg.setOnClickListener(this.mCallback455);
            this.mboundView5.setOnClickListener(this.mCallback456);
            this.mboundView6.setOnClickListener(this.mCallback457);
        }
        if ((18 & dirtyFlags) != 0) {
