...
public class SevenDasoardBindImpl extends SevenDasoardBind implements OnClickListener.Listener {
    ...
    public void executeBindings() {
        ...
        if ((dirtyFlags & PlaybackStateCompat.ACTION_PREPARE_FROM_SEARCH) != 0) {
            ...
            this.mboundView20.setOnClickListener(this.mCallback21);
            this.mboundView21.setOnClickListener(this.mCallback22);
            this.mboundView22.setOnClickListener(this.mCallback23);
            this.mboundView23.setOnClickListener(this.mCallback24);
        }
