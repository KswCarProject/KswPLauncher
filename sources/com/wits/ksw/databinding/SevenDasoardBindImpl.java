...
public class SevenDasoardBindImpl extends SevenDasoardBind implements OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & PlaybackStateCompat.ACTION_PREPARE_FROM_SEARCH) != 0) {
            this.mboundView17.setOnClickListener(this.mCallback300);
            this.mboundView18.setOnClickListener(this.mCallback301);
            this.mboundView19.setOnClickListener(this.mCallback302);
            this.mboundView20.setOnClickListener(this.mCallback303);
            this.mboundView21.setOnClickListener(this.mCallback304);
            this.mboundView22.setOnClickListener(this.mCallback305);
            this.mboundView23.setOnClickListener(this.mCallback306);
        }
