...
public class AudiMib3RightMediaBindingImpl extends AudiMib3RightMediaBinding implements OnClickListener.Listener {
    ...
    public void executeBindings() {
        ...
        if ((8 & dirtyFlags) != 0) {
            this.IvRightMusicIcon.setOnClickListener(this.mCallback134);
            this.btnMusicNext.setOnClickListener(this.mCallback137);
            this.btnMusicPlayPause.setOnClickListener(this.mCallback136);
            this.btnMusicPrev.setOnClickListener(this.mCallback135);
        }
        if ((dirtyFlags & 13) != 0) {
