...
public class AlsId7UiPhoneSubViewBindingImpl extends AlsId7UiPhoneSubViewBinding implements OnClickListener.Listener {
    ...
    public AlsId7UiPhoneSubViewBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private AlsId7UiPhoneSubViewBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public void executeBindings() {
        ...
        if ((dirtyFlags & 16) != 0) {
            this.phoneImageView.setOnClickListener(this.mCallback203);
        }
        if ((dirtyFlags & 24) != 0) {
