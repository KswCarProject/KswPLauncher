...
public class BenzNtgFyDashboardCardBindingHdpi1920x720Impl extends BenzNtgFyDashboardCardBinding implements OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback292);
            this.mboundView2.setOnClickListener(this.mCallback293);
            this.mboundView3.setOnClickListener(this.mCallback294);
        }
    }
