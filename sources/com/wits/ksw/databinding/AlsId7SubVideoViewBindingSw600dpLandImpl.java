...
public class AlsId7SubVideoViewBindingSw600dpLandImpl extends AlsId7SubVideoViewBinding implements OnClickListener.Listener {
    ...
    public AlsId7SubVideoViewBindingSw600dpLandImpl(@Nullable DataBindingComponent bindingComponent, @NonNull View root) {
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.videoImageView.setOnClickListener(this.mCallback132);
        }
    }
