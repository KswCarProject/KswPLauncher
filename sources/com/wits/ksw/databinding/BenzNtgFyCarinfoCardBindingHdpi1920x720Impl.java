...
public class BenzNtgFyCarinfoCardBindingHdpi1920x720Impl extends BenzNtgFyCarinfoCardBinding implements OnClickListener.Listener {
    ...
    private BenzNtgFyCarinfoCardBindingHdpi1920x720Impl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        this.mCallback430 = new OnClickListener(this, 3);
    ...
    protected void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback428);
            this.mboundView2.setOnClickListener(this.mCallback429);
            this.mboundView3.setOnClickListener(this.mCallback430);
        }
    }
