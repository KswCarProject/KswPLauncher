...
public class UgHomeOne2BindingImpl extends UgHomeOne2Binding implements OnClickListener.Listener {
    ...
    public void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.ugHomeBtVaiw.setOnClickListener(this.mCallback111);
            this.ugHomeMusicVaiw.setOnClickListener(this.mCallback112);
            this.ugHomeNaviVaiw.setOnClickListener(this.mCallback110);
        }
    }
