...
public class UgHomeOne2BindingImpl extends UgHomeOne2Binding implements OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.ugHomeBtVaiw.setOnClickListener(this.mCallback112);
            this.ugHomeMusicVaiw.setOnClickListener(this.mCallback113);
            this.ugHomeNaviVaiw.setOnClickListener(this.mCallback111);
        }
    }
