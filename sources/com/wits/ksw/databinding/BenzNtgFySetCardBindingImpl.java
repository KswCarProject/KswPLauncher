...
public class BenzNtgFySetCardBindingImpl extends BenzNtgFySetCardBinding implements OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        if ((2 & dirtyFlags) != 0) {
            this.benzMbuxLocalCardBg.setOnClickListener(this.mCallback459);
            this.mboundView2.setOnClickListener(this.mCallback460);
            this.mboundView3.setOnClickListener(this.mCallback461);
        }
    }
