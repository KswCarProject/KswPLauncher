...
public class Ntg6VoiceLayout extends RelativeLayout implements SeekBar.OnSeekBarChangeListener {
    ...
    public Ntg6VoiceLayout(Context context, Handler handler) {
        super(context);
        this.meiti = 26;
        this.htongh = 28;
        this.ytongh = 26;
        ...
        View view = LayoutInflater.from(context).inflate(C0899R.C0902layout.layout_ntg6_voice, (ViewGroup) null);
    ...
    private void initData() {
        ...
        contentResolver.registerContentObserver(Settings.System.getUriFor(KeyConfig.ANDROID_MEDIA_VOL), true, new ContentObserver(new Handler()) { // from class: com.wits.ksw.settings.ntg6.one_layout.Ntg6VoiceLayout.1
            @Override // android.database.ContentObserver
            public void onChange(boolean selfChange) {
                try {
                    int hz_mediaVolume = PowerManagerApp.getSettingsInt(KeyConfig.ANDROID_MEDIA_VOL);
                    Ntg6VoiceLayout.this.seek_mtb.setProgress(hz_mediaVolume);
    ...
    private void initView(View view) {
        ...
        this.img_TwoBack.setOnClickListener(new View.OnClickListener() { // from class: com.wits.ksw.settings.ntg6.one_layout.Ntg6VoiceLayout.2
