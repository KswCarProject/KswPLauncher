...
public class Ntg6FactoryLayout extends RelativeLayout implements View.OnClickListener {
    ...
    public Ntg6FactoryLayout(Context context, Handler handler) {
        super(context);
        this.context = context;
        this.handler = handler;
        View view = LayoutInflater.from(context).inflate(C0899R.C0902layout.layout_ntg6_factory, (ViewGroup) null);
    ...
    private void initView(View view) {
        ...
        this.img_del.setOnLongClickListener(new View.OnLongClickListener() { // from class: com.wits.ksw.settings.ntg6.one_layout.Ntg6FactoryLayout.1
