...
/* renamed from: com.wits.ksw.settings.audi_mib3.vm.AudiMib3LanguageViewModel */
...
public class AudiMib3LanguageViewModel extends AndroidViewModel {
    ...
    public AudiMib3LanguageViewModel(Application application) {
        ...
        this.contentObserver = new ContentObserver(new Handler()) { // from class: com.wits.ksw.settings.audi_mib3.vm.AudiMib3LanguageViewModel.1
