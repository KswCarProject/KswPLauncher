...
public class ID6SetVoiceLayout extends RelativeLayout implements SeekBar.OnSeekBarChangeListener {
    ...
    public ID6SetVoiceLayout(Context context) {
        super(context);
        this.meiti = 26;
        this.htongh = 28;
        this.ytongh = 26;
        ...
        View view = LayoutInflater.from(context).inflate(C0899R.C0902layout.layout_id6_set_voice, (ViewGroup) null);
    ...
    private void initData() {
        ...
        contentResolver.registerContentObserver(Settings.System.getUriFor(KeyConfig.ANDROID_MEDIA_VOL), true, new ContentObserver(new Handler()) { // from class: com.wits.ksw.settings.id6.oneLayout.ID6SetVoiceLayout.1
            @Override // android.database.ContentObserver
            public void onChange(boolean selfChange) {
                try {
                    int hz_mediaVolume = PowerManagerApp.getSettingsInt(KeyConfig.ANDROID_MEDIA_VOL);
                    ID6SetVoiceLayout.this.seek_mtb.setProgress(hz_mediaVolume);
