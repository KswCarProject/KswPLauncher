...
public class ID6FactoryLayout extends RelativeLayout implements View.OnClickListener {
    ...
    public ID6FactoryLayout(Context context, Handler handler) {
        super(context);
        this.context = context;
        this.handler = handler;
        View view = LayoutInflater.from(context).inflate(C0899R.C0902layout.layout_id6_factory, (ViewGroup) null);
    ...
    private void initView(View view) {
        ...
        this.img_del.setOnLongClickListener(new View.OnLongClickListener() { // from class: com.wits.ksw.settings.id6.oneLayout.ID6FactoryLayout.1
