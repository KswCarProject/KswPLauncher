...
public class SetSystemInfoLayout extends RelativeLayout implements View.OnClickListener {
    ...
    public SetSystemInfoLayout(Context context) {
        super(context);
        this.handler = new Handler() { // from class: com.wits.ksw.settings.id7.layout_one.SetSystemInfoLayout.1
            @Override // android.os.Handler
            public void handleMessage(Message msg) {
                super.handleMessage(msg);
                if (msg.what == 0) {
                    try {
                        String mvformat = String.format(SetSystemInfoLayout.this.getResources().getString(C0899R.string.text_8), McuUtil.getMcuVersion());
                        SetSystemInfoLayout.this.tv_infoMcuv.setText(mvformat);
                    } catch (Exception e) {
                        e.getStackTrace();
                    }
                } else if (msg.what == 1) {
        ...
        View view = LayoutInflater.from(context).inflate(C0899R.C0902layout.layout_set_sys_info, (ViewGroup) null);
    ...
    private void initView(View view) {
        ...
        PowerManagerApp.registerIContentObserver("mcuVerison", new IContentObserver.Stub() { // from class: com.wits.ksw.settings.id7.layout_one.SetSystemInfoLayout.2
        ...
        this.tv_infoSysv.setOnClickListener(new View.OnClickListener() { // from class: com.wits.ksw.settings.id7.layout_one.SetSystemInfoLayout.3
