...
public class SetVocModeLayout extends RelativeLayout {
    ...
    public SetVocModeLayout(Context context) {
        super(context);
        this.eqModel = 0;
    ...
    private void initView(View view) {
        ...
        this.rdg_vocmd.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // from class: com.wits.ksw.settings.id7.layout_one.SetVocModeLayout.1
