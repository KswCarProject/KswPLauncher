...
public class FunctionAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ViewHolder holder = new ViewHolder(LayoutInflater.from(this.context).inflate(C0899R.C0902layout.list_settings_function, viewGroup, false));
        return holder;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.relat_functionItem.setOnClickListener(new View.OnClickListener() { // from class: com.wits.ksw.settings.id7.adapter.FunctionAdapter.1
        ...
        holder.relat_functionItem.setOnKeyListener(new View.OnKeyListener() { // from class: com.wits.ksw.settings.id7.adapter.FunctionAdapter.2
