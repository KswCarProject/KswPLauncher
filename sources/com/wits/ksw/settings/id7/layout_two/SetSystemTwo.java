...
public class SetSystemTwo extends RelativeLayout {
    ...
    public SetSystemTwo(Context context) {
        super(context);
        this.mUpdateSliderRunnable = new Runnable() { // from class: com.wits.ksw.settings.id7.layout_two.SetSystemTwo.9
        ...
        View view = LayoutInflater.from(context).inflate(C0899R.C0902layout.layout_set_system_two, (ViewGroup) null);
    ...
    private void initView(View view) {
        ...
        this.seekbar_caux.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.wits.ksw.settings.id7.layout_two.SetSystemTwo.1
        ...
        this.seekbar_caux2.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.wits.ksw.settings.id7.layout_two.SetSystemTwo.2
            @Override // android.widget.SeekBar.OnSeekBarChangeListener
            public void onProgressChanged(SeekBar seekBar2, int progress, boolean fromUser) {
        ...
        this.seekbar_brightness.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.wits.ksw.settings.id7.layout_two.SetSystemTwo.3
            @Override // android.widget.SeekBar.OnSeekBarChangeListener
        ...
        this.rdg_shext.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // from class: com.wits.ksw.settings.id7.layout_two.SetSystemTwo.4
        ...
        this.tempRadioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // from class: com.wits.ksw.settings.id7.layout_two.SetSystemTwo.5
            @Override // android.widget.RadioGroup.OnCheckedChangeListener
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                for (int i2 = 0; i2 < count; i2++) {
                    if (checkedId == group.getChildAt(i2).getId()) {
                        ...
                        Log.i(SetSystemTwo.TAG, "save tempUnit  : " + i2);
                    }
        ...
        this.fuelRadioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // from class: com.wits.ksw.settings.id7.layout_two.SetSystemTwo.6
            @Override // android.widget.RadioGroup.OnCheckedChangeListener
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                int count = group.getChildCount();
                for (int i3 = 0; i3 < count; i3++) {
                    if (checkedId == group.getChildAt(i3).getId()) {
                        ...
                        Log.i(SetSystemTwo.TAG, "save tempUnit  : " + i3);
                    }
        ...
        VerRecyclerAdapter adapterMusic = new VerRecyclerAdapter(this.context, listMusic, C0899R.C0902layout.app_third_item_evo_id7);
        ...
        adapterMusic.setAppsCheckListener(new VerRecyclerAdapter.IAppsCheckListener() { // from class: com.wits.ksw.settings.id7.layout_two.SetSystemTwo.7
        ...
        VerRecyclerAdapter adapterVideo = new VerRecyclerAdapter(this.context, listVideo, C0899R.C0902layout.app_third_item_evo_id7);
        ...
        adapterVideo.setAppsCheckListener(new VerRecyclerAdapter.IAppsCheckListener() { // from class: com.wits.ksw.settings.id7.layout_two.SetSystemTwo.8
            @Override // com.wits.ksw.launcher.adpater.VerRecyclerAdapter.IAppsCheckListener
            public void checkedListener(String pkg, String cls, int pos) {
