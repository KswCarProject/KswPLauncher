...
public class NaviTwo extends RelativeLayout {
    ...
    public NaviTwo(Context context) {
        super(context);
        this.naviMin = 1;
        this.context = context;
        View view = LayoutInflater.from(context).inflate(C0899R.C0902layout.layout_set_navi_two, (ViewGroup) null);
    ...
    private void initView(View view) {
        ...
        this.naviAdapter.registCheckListener(new NaviAdapter.IrbtCheckListener() { // from class: com.wits.ksw.settings.id7.layout_two.NaviTwo.1
        ...
        this.rdg_naviv.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // from class: com.wits.ksw.settings.id7.layout_two.NaviTwo.2
