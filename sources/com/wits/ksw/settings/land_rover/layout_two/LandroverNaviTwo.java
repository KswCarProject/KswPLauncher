...
public class LandroverNaviTwo extends RelativeLayout {
    ...
    public LandroverNaviTwo(Context context) {
        super(context);
        this.naviMin = 1;
        this.context = context;
        View view = LayoutInflater.from(context).inflate(C0899R.C0902layout.land_rover_layout_set_navi_two, (ViewGroup) null);
    ...
    private void initView(View view) {
        ...
        this.naviAdapter.registCheckListener(new LandroverNaviAdapter.IrbtCheckListener() { // from class: com.wits.ksw.settings.land_rover.layout_two.LandroverNaviTwo.1
        ...
        this.rdg_naviv.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // from class: com.wits.ksw.settings.land_rover.layout_two.LandroverNaviTwo.2
