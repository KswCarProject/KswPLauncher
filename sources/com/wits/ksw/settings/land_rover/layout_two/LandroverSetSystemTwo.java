...
public class LandroverSetSystemTwo extends RelativeLayout {
    ...
    public static final String TAG = ("KswApplication." + LandroverSetSystemTwo.class.getSimpleName());
