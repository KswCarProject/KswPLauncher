...
public class LandroverSetFactoryLayout extends RelativeLayout implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.img_btn0 /*2131296772*/:
                if (this.pwdInput.length() <= 8) {
                    this.pwdInput.append("0");
                    break;
                }
                break;
            case R.id.img_btn1 /*2131296773*/:
                if (this.pwdInput.length() <= 8) {
                    this.pwdInput.append("1");
                    break;
                }
                break;
            case R.id.img_btn2 /*2131296774*/:
                if (this.pwdInput.length() <= 8) {
                    this.pwdInput.append("2");
                    break;
                }
                break;
            case R.id.img_btn3 /*2131296775*/:
                if (this.pwdInput.length() <= 8) {
                    this.pwdInput.append("3");
                    break;
                }
                break;
            case R.id.img_btn4 /*2131296776*/:
                if (this.pwdInput.length() <= 8) {
                    this.pwdInput.append("4");
                    break;
                }
                break;
            case R.id.img_btn5 /*2131296777*/:
                if (this.pwdInput.length() <= 8) {
                    this.pwdInput.append("5");
                    break;
                }
                break;
            case R.id.img_btn6 /*2131296778*/:
                if (this.pwdInput.length() <= 8) {
                    this.pwdInput.append("6");
                    break;
                }
                break;
            case R.id.img_btn7 /*2131296779*/:
                if (this.pwdInput.length() <= 8) {
                    this.pwdInput.append("7");
                    break;
                }
                break;
            case R.id.img_btn8 /*2131296780*/:
                if (this.pwdInput.length() <= 8) {
                    this.pwdInput.append("8");
                    break;
                }
                break;
            case R.id.img_btn9 /*2131296781*/:
                if (this.pwdInput.length() <= 8) {
                    this.pwdInput.append("9");
                    break;
                }
                break;
            case R.id.img_del /*2131296782*/:
                ...
                break;
            case R.id.img_enter /*2131296783*/:
