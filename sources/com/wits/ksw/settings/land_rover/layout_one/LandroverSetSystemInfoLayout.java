...
public class LandroverSetSystemInfoLayout extends RelativeLayout implements View.OnClickListener {
    ...
    public LandroverSetSystemInfoLayout(Context context) {
        super(context);
        this.handler = new Handler() { // from class: com.wits.ksw.settings.land_rover.layout_one.LandroverSetSystemInfoLayout.1
            @Override // android.os.Handler
            public void handleMessage(Message msg) {
                super.handleMessage(msg);
                if (msg.what == 0) {
                    try {
                        String mvformat = String.format(LandroverSetSystemInfoLayout.this.getResources().getString(C0899R.string.text_8), McuUtil.getMcuVersion());
                        LandroverSetSystemInfoLayout.this.tv_infoMcuv.setText(mvformat);
                    } catch (Exception e) {
                        e.getStackTrace();
                    }
                } else if (msg.what == 1) {
        ...
        View view = LayoutInflater.from(context).inflate(C0899R.C0902layout.land_rover_layout_set_sys_info, (ViewGroup) null);
    ...
    private void initView(View view) {
        ...
        PowerManagerApp.registerIContentObserver("mcuVerison", new IContentObserver.Stub() { // from class: com.wits.ksw.settings.land_rover.layout_one.LandroverSetSystemInfoLayout.2
        ...
        this.tv_infoSysv.setOnClickListener(new View.OnClickListener() { // from class: com.wits.ksw.settings.land_rover.layout_one.LandroverSetSystemInfoLayout.3
