...
public class LandroverSetNaviLayout extends RelativeLayout implements View.OnClickListener {
    ...
    public LandroverSetNaviLayout(Context context) {
        super(context);
        this.context = context;
        View view = LayoutInflater.from(context).inflate(C0899R.C0902layout.land_rover_layout_set_navi, (ViewGroup) null);
