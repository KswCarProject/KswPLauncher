...
public class LandroverLanguageAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public LandroverLanguageAdapter(Context context, List<FunctionBean> appInfoList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ViewHolder holder = new ViewHolder(LayoutInflater.from(this.context).inflate(C0899R.C0902layout.land_rover_list_settings_language, viewGroup, false));
        return holder;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.img_functionItem.setOnClickListener(new View.OnClickListener() { // from class: com.wits.ksw.settings.land_rover.adapter.LandroverLanguageAdapter.1
