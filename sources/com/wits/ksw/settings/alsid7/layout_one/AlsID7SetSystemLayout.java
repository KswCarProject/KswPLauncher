...
public class AlsID7SetSystemLayout extends RelativeLayout implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public AlsID7SetSystemLayout(Context context) {
        super(context);
        this.housi = 0;
        this.cheVideo = 0;
        this.dcgj = 0;
        ...
        View view = LayoutInflater.from(context).inflate(C0899R.C0902layout.als_layout_set_system, (ViewGroup) null);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case C0899R.C0901id.tv_music_app /* 2131297952 */:
                this.tv_music_app.setTextColor(getResources().getColor(C0899R.color.alsid7_text_bule, null));
                this.updateTwoLayout.updateTwoLayout(1, 6);
                return;
            case C0899R.C0901id.tv_sysBgld /* 2131297981 */:
                this.tv_sysBgld.setTextColor(getResources().getColor(C0899R.color.alsid7_text_bule, null));
            ...
            case C0899R.C0901id.tv_sysDcsxt /* 2131297983 */:
                this.tv_sysDcsxt.setTextColor(getResources().getColor(C0899R.color.alsid7_text_bule, null));
                this.updateTwoLayout.updateTwoLayout(1, 1);
                return;
            case C0899R.C0901id.tv_sysFuelUnit /* 2131297984 */:
                this.fuelUnitView.setTextColor(getResources().getColor(C0899R.color.alsid7_text_bule, null));
                this.updateTwoLayout.updateTwoLayout(1, 5);
                return;
            case C0899R.C0901id.tv_sysTempUnit /* 2131297985 */:
                this.tempUnitView.setTextColor(getResources().getColor(C0899R.color.alsid7_text_bule, null));
                this.updateTwoLayout.updateTwoLayout(1, 4);
                return;
            case C0899R.C0901id.tv_video_app /* 2131298003 */:
                this.tv_video_app.setTextColor(getResources().getColor(C0899R.color.alsid7_text_bule, null));
