...
public class AlsID7SetSystemInfoLayout extends RelativeLayout implements View.OnClickListener {
    ...
    Handler handler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 0) {
                try {
                    AlsID7SetSystemInfoLayout.this.tv_infoMcuv.setText(String.format(AlsID7SetSystemInfoLayout.this.getResources().getString(R.string.text_8), new Object[]{McuUtil.getMcuVersion()}));
                } catch (Exception e) {
                    e.getStackTrace();
                }
            } else if (msg.what == 1) {
