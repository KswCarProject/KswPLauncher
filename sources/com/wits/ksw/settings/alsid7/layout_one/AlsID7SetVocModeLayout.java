...
public class AlsID7SetVocModeLayout extends RelativeLayout {
    ...
    public AlsID7SetVocModeLayout(Context context) {
        super(context);
        this.eqModel = 0;
    ...
    private void initView(View view) {
        ...
        this.rdg_vocmd.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // from class: com.wits.ksw.settings.alsid7.layout_one.AlsID7SetVocModeLayout.1
