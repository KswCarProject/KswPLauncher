...
public class AlsID7SetLanguageLayout extends RelativeLayout {
    ...
    public AlsID7SetLanguageLayout(Context context) {
        super(context);
        this.defLanguage = 0;
        this.context = context;
        View view = LayoutInflater.from(context).inflate(C0899R.C0902layout.layout_set_language, (ViewGroup) null);
    ...
    private void initView(View view) {
        ...
        this.adapter.registOnFunctionClickListener(new AlsID7LanguageAdapter.OnFunctionClickListener() { // from class: com.wits.ksw.settings.alsid7.layout_one.AlsID7SetLanguageLayout.1
