...
public class AlsID7SetVocModelTwo extends RelativeLayout implements SeekBar.OnSeekBarChangeListener {
    ...
    public AlsID7SetVocModelTwo(Context context) {
        super(context);
        this.barMax = 24;
        this.f217di = 12;
        this.f219zo = 12;
    ...
    private void initData() {
        try {
            this.f217di = PowerManagerApp.getSettingsInt(KeyConfig.EQ_BASS);
            this.f219zo = PowerManagerApp.getSettingsInt(KeyConfig.EQ_MIDDLE);
            this.f218ga = PowerManagerApp.getSettingsInt(KeyConfig.EQ_TREBLE);
            this.eqModel = PowerManagerApp.getSettingsInt(KeyConfig.EQ_MODE);
            Log.d("EqData", "get settings data model:" + this.eqModel + "\tdi:" + this.f217di + "\tzo:" + this.f219zo + "\tga:" + this.f218ga);
        } catch (Exception e) {
            e.getStackTrace();
        }
    }
    ...
    private void initBarView(int index) {
        switch (index) {
            case 0:
                this.seekbar_mdi.setProgress(this.f217di);
                this.seekbar_mzh.setProgress(this.f219zo);
                this.seekbar_mgo.setProgress(this.f218ga);
                break;
            case 1:
        ...
        Log.d("EqData", "init view data model:" + this.eqModel + "\tdi:" + this.f217di + "\tzo:" + this.f219zo + "\tga:" + this.f218ga);
    }
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        switch (seekBar.getId()) {
            ...
            case C0899R.C0901id.seekbar_mzh /* 2131297745 */:
                ...
                if (this.eqModel == 0) {
                    this.f219zo = progress;
                    FileUtils.savaIntData(KeyConfig.EQ_MIDDLE, progress);
                    break;
                }
                break;
        }
        Log.d("EqData", "set and select model data model:" + this.eqModel + "\tdi:" + this.f217di + "\tzo:" + this.f219zo + "\tga:" + this.f218ga);
    }
