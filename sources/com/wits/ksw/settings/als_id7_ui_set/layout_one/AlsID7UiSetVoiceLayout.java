...
public class AlsID7UiSetVoiceLayout extends RelativeLayout implements SeekBar.OnSeekBarChangeListener {
    ...
    public AlsID7UiSetVoiceLayout(Context context) {
        super(context);
        this.meiti = 26;
        this.htongh = 28;
        this.ytongh = 26;
        ...
        View view = LayoutInflater.from(context).inflate(C0899R.C0902layout.als_id7_ui_layout_set_voice, (ViewGroup) null);
    ...
    private void initData() {
        ...
        contentResolver.registerContentObserver(Settings.System.getUriFor(KeyConfig.ANDROID_MEDIA_VOL), true, new ContentObserver(new Handler()) { // from class: com.wits.ksw.settings.als_id7_ui_set.layout_one.AlsID7UiSetVoiceLayout.1
            @Override // android.database.ContentObserver
            public void onChange(boolean selfChange) {
                try {
                    int hz_mediaVolume = PowerManagerApp.getSettingsInt(KeyConfig.ANDROID_MEDIA_VOL);
                    AlsID7UiSetVoiceLayout.this.seek_mtb.setProgress(hz_mediaVolume);
                } catch (RemoteException e2) {
                }
            }
        });
        contentResolver.registerContentObserver(Settings.System.getUriFor(KeyConfig.ANDROID_PHONE_VOL), true, new ContentObserver(new Handler()) { // from class: com.wits.ksw.settings.als_id7_ui_set.layout_one.AlsID7UiSetVoiceLayout.2
            @Override // android.database.ContentObserver
            public void onChange(boolean selfChange) {
                try {
                    int hz_callVolume = PowerManagerApp.getSettingsInt(KeyConfig.ANDROID_PHONE_VOL);
                    AlsID7UiSetVoiceLayout.this.seek_tonghb.setProgress(hz_callVolume);
                } catch (RemoteException e2) {
                }
            }
        });
