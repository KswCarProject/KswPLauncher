...
public class AlsID7UiSetFactoryLayout extends RelativeLayout implements View.OnClickListener {
    ...
    public AlsID7UiSetFactoryLayout(Context context, Handler handler) {
        super(context);
        this.context = context;
        this.handler = handler;
        View view = LayoutInflater.from(context).inflate(C0899R.C0902layout.als_id7_ui_layout_set_factory, (ViewGroup) null);
    ...
    private void initView(View view) {
        ...
        this.img_del.setOnLongClickListener(new View.OnLongClickListener() { // from class: com.wits.ksw.settings.als_id7_ui_set.layout_one.AlsID7UiSetFactoryLayout.1
