...
public class AlsID7UiSetSystemInfoLayout extends RelativeLayout implements View.OnClickListener {
    ...
    public AlsID7UiSetSystemInfoLayout(Context context) {
        super(context);
        this.handler = new Handler() { // from class: com.wits.ksw.settings.als_id7_ui_set.layout_one.AlsID7UiSetSystemInfoLayout.1
            @Override // android.os.Handler
            public void handleMessage(Message msg) {
                super.handleMessage(msg);
                if (msg.what == 0) {
                    try {
                        String mvformat = String.format(AlsID7UiSetSystemInfoLayout.this.getResources().getString(C0899R.string.text_8), McuUtil.getMcuVersion());
                        AlsID7UiSetSystemInfoLayout.this.tv_infoMcuv.setText(mvformat);
                    } catch (Exception e) {
                        e.getStackTrace();
                    }
                } else if (msg.what == 1) {
        ...
        View view = LayoutInflater.from(context).inflate(C0899R.C0902layout.als_id7_ui_layout_set_sys_info, (ViewGroup) null);
    ...
    private void initView(View view) {
        ...
        PowerManagerApp.registerIContentObserver("mcuVerison", new IContentObserver.Stub() { // from class: com.wits.ksw.settings.als_id7_ui_set.layout_one.AlsID7UiSetSystemInfoLayout.2
        ...
        this.tv_infoSysv.setOnClickListener(new View.OnClickListener() { // from class: com.wits.ksw.settings.als_id7_ui_set.layout_one.AlsID7UiSetSystemInfoLayout.3
