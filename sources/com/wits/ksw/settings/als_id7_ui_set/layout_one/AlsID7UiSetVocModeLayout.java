...
public class AlsID7UiSetVocModeLayout extends RelativeLayout {
    ...
    public AlsID7UiSetVocModeLayout(Context context) {
        super(context);
        this.eqModel = 0;
        this.context = context;
        View view = LayoutInflater.from(context).inflate(C0899R.C0902layout.als_id7_ui_layout_set_voc_model, (ViewGroup) null);
    ...
    private void initView(View view) {
        ...
        this.rdg_vocmd.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // from class: com.wits.ksw.settings.als_id7_ui_set.layout_one.AlsID7UiSetVocModeLayout.1
