...
public class AlsID7UiNaviTwo extends RelativeLayout {
    ...
    public AlsID7UiNaviTwo(Context context) {
        super(context);
        this.naviMin = 1;
        this.context = context;
        View view = LayoutInflater.from(context).inflate(C0899R.C0902layout.als_id7_ui_layout_set_navi_two, (ViewGroup) null);
    ...
    private void initView(View view) {
        ...
        this.naviAdapter.registCheckListener(new AlsID7UiNaviAdapter.IrbtCheckListener() { // from class: com.wits.ksw.settings.als_id7_ui_set.layout_two.AlsID7UiNaviTwo.1
        ...
        this.rdg_naviv.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // from class: com.wits.ksw.settings.als_id7_ui_set.layout_two.AlsID7UiNaviTwo.2
