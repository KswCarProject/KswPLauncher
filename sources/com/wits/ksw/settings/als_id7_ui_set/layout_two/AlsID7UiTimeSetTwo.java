...
public class AlsID7UiTimeSetTwo extends RelativeLayout implements RadioGroup.OnCheckedChangeListener {
    ...
    public AlsID7UiTimeSetTwo(Context context) {
        super(context);
        this.context = context;
        View view = LayoutInflater.from(context).inflate(C0899R.C0902layout.als_id7_ui_layout_set_time_two, (ViewGroup) null);
