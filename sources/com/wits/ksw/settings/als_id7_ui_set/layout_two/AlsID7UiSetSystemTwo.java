    ...
    private void initView(View view) {
        ...
        adapterMusic.setAppsCheckListener(new AlsID7UiVerRecyclerAdapter.IAppsCheckListener() {
            public void checkedListener(String pkg, String cls, int pos) {
                ...
                Settings.System.putString(AlsID7UiSetSystemTwo.this.context.getContentResolver(), LauncherViewModel.KEY_SHORTCUT_PKG_1, pkg);
                Settings.System.putString(AlsID7UiSetSystemTwo.this.context.getContentResolver(), LauncherViewModel.KEY_SHORTCUT_CLS_1, cls);
