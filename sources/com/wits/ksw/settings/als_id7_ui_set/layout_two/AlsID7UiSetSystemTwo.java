...
public class AlsID7UiSetSystemTwo extends RelativeLayout {
    ...
    public AlsID7UiSetSystemTwo(Context context) {
        super(context);
        this.mUpdateSliderRunnable = new Runnable() { // from class: com.wits.ksw.settings.als_id7_ui_set.layout_two.AlsID7UiSetSystemTwo.10
        ...
        View view = LayoutInflater.from(context).inflate(C0899R.C0902layout.als_id7_ui_layout_set_system_two, (ViewGroup) null);
    ...
    private void initView(View view) {
        ...
        this.seekbar_caux.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.wits.ksw.settings.als_id7_ui_set.layout_two.AlsID7UiSetSystemTwo.1
        ...
        this.seekbar_caux2.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.wits.ksw.settings.als_id7_ui_set.layout_two.AlsID7UiSetSystemTwo.2
            @Override // android.widget.SeekBar.OnSeekBarChangeListener
            public void onProgressChanged(SeekBar seekBar2, int progress, boolean fromUser) {
        ...
        this.seekbar_brightness.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.wits.ksw.settings.als_id7_ui_set.layout_two.AlsID7UiSetSystemTwo.3
            @Override // android.widget.SeekBar.OnSeekBarChangeListener
        ...
        this.rdg_shext.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // from class: com.wits.ksw.settings.als_id7_ui_set.layout_two.AlsID7UiSetSystemTwo.4
        ...
        this.tempRadioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // from class: com.wits.ksw.settings.als_id7_ui_set.layout_two.AlsID7UiSetSystemTwo.5
            @Override // android.widget.RadioGroup.OnCheckedChangeListener
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                for (int i2 = 0; i2 < count; i2++) {
                    if (checkedId == group.getChildAt(i2).getId()) {
                        ...
                        Log.i(AlsID7UiSetSystemTwo.TAG, "save tempUnit  : " + i2);
                    }
        ...
        this.fuelRadioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // from class: com.wits.ksw.settings.als_id7_ui_set.layout_two.AlsID7UiSetSystemTwo.6
            @Override // android.widget.RadioGroup.OnCheckedChangeListener
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                int count = group.getChildCount();
                for (int i3 = 0; i3 < count; i3++) {
                    if (checkedId == group.getChildAt(i3).getId()) {
                        ...
                        Log.i(AlsID7UiSetSystemTwo.TAG, "save tempUnit  : " + i3);
                    }
        ...
        AlsID7UiVerRecyclerAdapter adapterMusic = new AlsID7UiVerRecyclerAdapter(this.context, listMusic, C0899R.C0902layout.app_third_item_als_id7_ui);
        ...
        adapterMusic.setIFocusListener(new AlsID7UiVerRecyclerAdapter.IFocusListener() { // from class: com.wits.ksw.settings.als_id7_ui_set.layout_two.AlsID7UiSetSystemTwo.7
        ...
        adapterMusic.setAppsCheckListener(new AlsID7UiVerRecyclerAdapter.IAppsCheckListener() { // from class: com.wits.ksw.settings.als_id7_ui_set.layout_two.AlsID7UiSetSystemTwo.8
        ...
        AlsID7UiVerRecyclerAdapter adapterVideo = new AlsID7UiVerRecyclerAdapter(this.context, listVideo, C0899R.C0902layout.app_third_item_als_id7_ui);
        ...
        adapterVideo.setAppsCheckListener(new AlsID7UiVerRecyclerAdapter.IAppsCheckListener() { // from class: com.wits.ksw.settings.als_id7_ui_set.layout_two.AlsID7UiSetSystemTwo.9
            @Override // com.wits.ksw.settings.als_id7_ui_set.adapter.AlsID7UiVerRecyclerAdapter.IAppsCheckListener
            public void checkedListener(String pkg, String cls, int pos) {
