...
public class AlsID7UiLanguageAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public AlsID7UiLanguageAdapter(Context context, List<FunctionBean> appInfoList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ViewHolder holder = new ViewHolder(LayoutInflater.from(this.context).inflate(C0899R.C0902layout.als_id7_ui_list_settings_language, viewGroup, false));
        return holder;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.img_functionItem.setOnClickListener(new View.OnClickListener() { // from class: com.wits.ksw.settings.als_id7_ui_set.adapter.AlsID7UiLanguageAdapter.1
