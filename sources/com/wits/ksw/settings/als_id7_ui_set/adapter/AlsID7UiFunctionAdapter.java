...
public class AlsID7UiFunctionAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public AlsID7UiFunctionAdapter(Context context, List<FunctionBean> appInfoList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ViewHolder holder = new ViewHolder(LayoutInflater.from(this.context).inflate(C0899R.C0902layout.als_id7_ui_list_settings_function, viewGroup, false));
        return holder;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (this.data.get(position).isIscheck()) {
            holder.tv_functionItem.setTextColor(SkinCompatResources.getColor(this.context, C0899R.color.als_id7_ui_text_color));
        } else {
            holder.tv_functionItem.setTextColor(-1);
        }
        holder.relat_functionItem.setOnClickListener(new View.OnClickListener() { // from class: com.wits.ksw.settings.als_id7_ui_set.adapter.AlsID7UiFunctionAdapter.1
        ...
        holder.relat_functionItem.setOnKeyListener(new View.OnKeyListener() { // from class: com.wits.ksw.settings.als_id7_ui_set.adapter.AlsID7UiFunctionAdapter.2
