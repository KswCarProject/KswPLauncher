...
public class BmwId8SettingsVideoAdapter extends BaseQuickAdapter<LexusLsAppSelBean, BaseViewHolder> {
    ...
    public BmwId8SettingsVideoAdapter(List<LexusLsAppSelBean> data) {
        super(C0899R.C0902layout.bmw_id8_settings_system_video_item, data);
        this.TAG = "BmwId8SettingsVideoAdapter";
    }
    ...
    public void convert(BaseViewHolder helper, final LexusLsAppSelBean item) {
        if (item != null) {
            helper.setChecked(C0899R.C0901id.bmw_id8_settings_system_video_item_btn, item.isChecked());
            helper.setText(C0899R.C0901id.bmw_id8_settings_system_video_item_title, item.getAppName());
            helper.itemView.setOnTouchListener(new View.OnTouchListener() { // from class: com.wits.ksw.settings.bmw_id8.adapter.BmwId8SettingsVideoAdapter.1
            ...
            helper.itemView.setOnKeyListener(new View.OnKeyListener() { // from class: com.wits.ksw.settings.bmw_id8.adapter.BmwId8SettingsVideoAdapter.2
                ...
                public boolean onKey(View v, int keyCode, KeyEvent event) {
                    ...
                    return keyCode == 19 ? position == 0 : keyCode == 20 && position == BmwId8SettingsVideoAdapter.this.getData().size() - 1;
                }
            });
        }
    }
