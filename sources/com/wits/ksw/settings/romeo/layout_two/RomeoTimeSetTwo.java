...
public class RomeoTimeSetTwo extends RelativeLayout implements RadioGroup.OnCheckedChangeListener {
    ...
    public RomeoTimeSetTwo(Context context) {
        super(context);
        this.context = context;
        View view = LayoutInflater.from(context).inflate(C0899R.C0902layout.romeo_layout_set_time_two, (ViewGroup) null);
    ...
    private void initView(View view) {
        ...
        for (int i = 0; i < this.rdg_timeSy.getChildCount(); i++) {
            final int finalI = i;
            this.rdg_timeSy.getChildAt(i).setOnTouchListener(new View.OnTouchListener() { // from class: com.wits.ksw.settings.romeo.layout_two.RomeoTimeSetTwo.1
            ...
            this.rdg_timeSy.getChildAt(i).setOnFocusChangeListener(new View.OnFocusChangeListener() { // from class: com.wits.ksw.settings.romeo.layout_two.RomeoTimeSetTwo.2
                @Override // android.view.View.OnFocusChangeListener
                public void onFocusChange(View view2, boolean b) {
                    int i2 = finalI;
                    if (i2 == 0) {
                        RomeoTimeSetTwo.this.romeo_list_r1.setVisibility(b ? 0 : 4);
                    } else if (i2 == 1) {
                        RomeoTimeSetTwo.this.romeo_list_r2.setVisibility(b ? 0 : 4);
                    }
                }
            });
        }
        for (int i2 = 0; i2 < this.rdg_timeZhis.getChildCount(); i2++) {
            ...
            this.rdg_timeZhis.getChildAt(i2).setOnTouchListener(new View.OnTouchListener() { // from class: com.wits.ksw.settings.romeo.layout_two.RomeoTimeSetTwo.3
                @Override // android.view.View.OnTouchListener
                public boolean onTouch(View view2, MotionEvent motionEvent) {
                    if (motionEvent.getAction() == 0) {
                        int i3 = finalI2;
            ...
            this.rdg_timeZhis.getChildAt(i2).setOnFocusChangeListener(new View.OnFocusChangeListener() { // from class: com.wits.ksw.settings.romeo.layout_two.RomeoTimeSetTwo.4
                @Override // android.view.View.OnFocusChangeListener
                public void onFocusChange(View view2, boolean b) {
                    int i3 = finalI2;
                    if (i3 == 0) {
