...
public class RomeoSetSystemInfoLayout extends RelativeLayout implements View.OnClickListener {
    ...
    Handler handler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 0) {
                try {
                    RomeoSetSystemInfoLayout.this.tv_infoMcuv.setText(String.format(RomeoSetSystemInfoLayout.this.getResources().getString(R.string.text_8), new Object[]{McuUtil.getMcuVersion()}));
                } catch (Exception e) {
                    e.getStackTrace();
                }
            } else if (msg.what == 1) {
