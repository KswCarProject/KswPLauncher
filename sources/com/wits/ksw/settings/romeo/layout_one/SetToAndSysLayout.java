            ...
            viewGroup.getChildAt(i).setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View view, MotionEvent motionEvent) {
                    ...
                    if (motionEvent.getAction() == 0) {
                        SetToAndSysLayout.this.updateListBg.updateListBg(locW[1] - 78, 2);
                    } else if (motionEvent.getAction() == 1) {
                        SetToAndSysLayout.this.updateListBg.updateListBg(locW[1] - 78, 0);
            ...
            viewGroup.getChildAt(i).setOnFocusChangeListener(new View.OnFocusChangeListener() {
                public void onFocusChange(View view, boolean b) {
                    if (b) {
                        int[] locW = new int[2];
                        viewGroup.getChildAt(finalI).getLocationInWindow(locW);
                        SetToAndSysLayout.this.updateListBg.updateListBg(locW[1] - 78, 1);
                        return;
                    }
                    SetToAndSysLayout.this.updateListBg.updateListBg(0, 0);
                }
            });
        }
    }
