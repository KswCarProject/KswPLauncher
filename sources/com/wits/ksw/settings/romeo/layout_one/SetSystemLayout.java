...
public class SetSystemLayout extends RelativeLayout implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            SetSystemLayout.this.set_system_scroll.scrollTo(0, count * 107);
        }
    };
        ...
        this.set_system_scroll.setOnScrollChangeListener(new View.OnScrollChangeListener() {
            public void onScrollChange(View view, int i, int i1, int i2, int i3) {
                ...
                for (int n = 0; n < SetSystemLayout.this.set_system_ll.getChildCount(); n++) {
                    ...
                    int unused = SetSystemLayout.this.downY = i1;
                    SetSystemLayout.this.mHandler.sendEmptyMessageDelayed(0, 200);
                }
            }
        });
    }
            ...
            viewGroup.getChildAt(i).setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View view, MotionEvent motionEvent) {
                    ...
                    if (motionEvent.getAction() == 0) {
                        ...
                        SetSystemLayout.this.updateListBg.updateListBg(locW[1] - 78, 0);
