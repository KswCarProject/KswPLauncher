...
public class UtilsInfo {
    ...
    public static String getSettingsVer(Context context) {
        ...
        return context.getString(R.string.audi_set_sys_info_system_ver, new Object[]{version});
    }
    ...
    public static String getSettingsVersion(Context context) {
        ...
        if (!TextUtils.isEmpty(getBaseband_Ver())) {
            ...
            String string = context.getString(R.string.audi_set_sys_info_system_ver, new Object[]{realVer + "-" + pingtai});
            if (index_NA > -1) {
                if (index_platform_M501 > -1) {
                    return realVer + "-" + pingtai + "NA-1";
                }
                return realVer + "-" + pingtai + "NA";
            } else if (index_platform_M501 > -1) {
                return realVer + "-" + pingtai + "EA-1";
            } else {
                return realVer + "-" + pingtai + "EA";
            }
        } else {
