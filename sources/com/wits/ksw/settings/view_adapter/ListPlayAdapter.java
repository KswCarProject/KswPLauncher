...
public class ListPlayAdapter extends RecyclerView.Adapter<MyViewHolder> {
    ...
    public ListPlayAdapter(Context context, List<DevBean> data) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        MyViewHolder holder = new MyViewHolder(LayoutInflater.from(this.context).inflate(C0899R.C0902layout.navi_settings_adpter_layout, viewGroup, false));
        return holder;
    }
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        if (this.rbtCheckListener != null) {
            holder.rbt_navi.setOnClickListener(new View.OnClickListener() { // from class: com.wits.ksw.settings.view_adapter.ListPlayAdapter.1
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            this.marqueeTextView = (MarqueeTextView) itemView.findViewById(C0899R.C0901id.mtv_tv);
        }
    }
}
