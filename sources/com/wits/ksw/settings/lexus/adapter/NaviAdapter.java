...
public class NaviAdapter extends RecyclerView.Adapter<MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        MyViewHolder holder = new MyViewHolder(LayoutInflater.from(this.context).inflate(C0899R.C0902layout.lexus_navi_adpter_layout, viewGroup, false));
        return holder;
    }
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        if (this.rbtCheckListener != null) {
            holder.rbt_navi.setOnClickListener(new View.OnClickListener() { // from class: com.wits.ksw.settings.lexus.adapter.NaviAdapter.1
        ...
        holder.rbt_navi.setOnKeyListener(new View.OnKeyListener() { // from class: com.wits.ksw.settings.lexus.adapter.NaviAdapter.2
