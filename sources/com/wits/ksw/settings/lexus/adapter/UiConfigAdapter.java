...
public class UiConfigAdapter extends RecyclerView.Adapter<MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        if (this.rbtCheckListener != null) {
            holder.relat_listTv.setOnClickListener(new View.OnClickListener() { // from class: com.wits.ksw.settings.lexus.adapter.UiConfigAdapter.1
        ...
        holder.relat_listTv.setOnKeyListener(new View.OnKeyListener() { // from class: com.wits.ksw.settings.lexus.adapter.UiConfigAdapter.2
