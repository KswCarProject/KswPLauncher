...
public class LexusSetFactoryLayout extends RelativeLayout implements View.OnClickListener {
    ...
    public LexusSetFactoryLayout(Context context, Handler handler) {
        super(context);
        this.context = context;
        this.handler = handler;
        View view = LayoutInflater.from(context).inflate(C0899R.C0902layout.lexus_layout_set_factory, (ViewGroup) null);
    ...
    private void initView(View view) {
        ...
        this.img_del.setOnLongClickListener(new View.OnLongClickListener() { // from class: com.wits.ksw.settings.lexus.layout_one.LexusSetFactoryLayout.1
