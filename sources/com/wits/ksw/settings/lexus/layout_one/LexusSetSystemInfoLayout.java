...
public class LexusSetSystemInfoLayout extends RelativeLayout implements View.OnClickListener {
    ...
    Handler handler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 0) {
                try {
                    LexusSetSystemInfoLayout.this.tv_infoMcuv.setText(String.format(LexusSetSystemInfoLayout.this.getResources().getString(R.string.text_8), new Object[]{McuUtil.getMcuVersion()}));
                } catch (Exception e) {
                    e.getStackTrace();
                }
            } else if (msg.what == 1) {
    ...
    private void initView(View view) {
        ...
        TextView textView7 = (TextView) view.findViewById(R.id.tv_infoSysUpDate);
