...
public class LexusSetVocModeLayout extends RelativeLayout {
    ...
    public LexusSetVocModeLayout(Context context) {
        super(context);
        this.eqModel = 0;
    ...
    private void initView(View view) {
        ...
        this.rdg_vocmd.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // from class: com.wits.ksw.settings.lexus.layout_one.LexusSetVocModeLayout.1
