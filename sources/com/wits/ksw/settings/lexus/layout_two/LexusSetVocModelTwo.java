...
public class LexusSetVocModelTwo extends RelativeLayout implements SeekBar.OnSeekBarChangeListener {
    ...
    public LexusSetVocModelTwo(Context context) {
        super(context);
        this.barMax = 24;
        this.f234di = 12;
        this.f236zo = 12;
    ...
    private void initData() {
        try {
            this.f234di = PowerManagerApp.getSettingsInt(KeyConfig.EQ_BASS);
            this.f236zo = PowerManagerApp.getSettingsInt(KeyConfig.EQ_MIDDLE);
            this.f235ga = PowerManagerApp.getSettingsInt(KeyConfig.EQ_TREBLE);
            this.eqModel = PowerManagerApp.getSettingsInt(KeyConfig.EQ_MODE);
            Log.d("EqData", "get settings data model:" + this.eqModel + "\tdi:" + this.f234di + "\tzo:" + this.f236zo + "\tga:" + this.f235ga);
        } catch (Exception e) {
            e.getStackTrace();
        }
    }
    ...
    private void initBarView(int index) {
        switch (index) {
            case 0:
                this.seekbar_mdi.setProgress(this.f234di);
                this.seekbar_mzh.setProgress(this.f236zo);
                this.seekbar_mgo.setProgress(this.f235ga);
                break;
            case 1:
        ...
        Log.d("EqData", "init view data model:" + this.eqModel + "\tdi:" + this.f234di + "\tzo:" + this.f236zo + "\tga:" + this.f235ga);
    }
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        switch (seekBar.getId()) {
            ...
            case C0899R.C0901id.seekbar_mzh /* 2131297745 */:
                ...
                if (this.eqModel == 0) {
                    this.f236zo = progress;
                    FileUtils.savaIntData(KeyConfig.EQ_MIDDLE, progress);
                    break;
                }
                break;
        }
        Log.d("EqData", "set and select model data model:" + this.eqModel + "\tdi:" + this.f234di + "\tzo:" + this.f236zo + "\tga:" + this.f235ga);
    }
