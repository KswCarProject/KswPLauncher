...
public class LexusSetVoiceTwo extends RelativeLayout implements SeekBar.OnSeekBarChangeListener {
    ...
    public LexusSetVoiceTwo(Context context) {
        super(context);
        this.meiti = 26;
        this.htongh = 28;
        this.ytongh = 26;
        this.daohan = 26;
        this.TAG = "SetVoiceTwo";
        this.context = context;
        View view = LayoutInflater.from(context).inflate(C0899R.C0902layout.lexus_layout_set_voice_two, (ViewGroup) null);
    ...
    private void initData() {
        ...
        contentResolver.registerContentObserver(Settings.System.getUriFor(KeyConfig.ANDROID_MEDIA_VOL), true, new ContentObserver(new Handler()) { // from class: com.wits.ksw.settings.lexus.layout_two.LexusSetVoiceTwo.1
            @Override // android.database.ContentObserver
            public void onChange(boolean selfChange) {
                try {
                    int hz_mediaVolume = PowerManagerApp.getSettingsInt(KeyConfig.ANDROID_MEDIA_VOL);
                    LexusSetVoiceTwo.this.seek_mtb.setProgress(hz_mediaVolume);
    ...
    private void initView(View view) {
        this.ll_bv = (LinearLayout) view.findViewById(C0899R.C0901id.ll_bv);
        this.ll_ov = (LinearLayout) view.findViewById(C0899R.C0901id.ll_ov);
