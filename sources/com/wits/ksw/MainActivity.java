...
public class MainActivity extends BaseThemeActivity {
    ...
    public ContentObserver contentObserver = new ContentObserver(new Handler()) {
        public void onChange(boolean selfChange, Uri uri) {
            Log.d(MainActivity.TAG, "onChange: 11111111111");
            if (uri.equals(Settings.System.getUriFor("SkinName"))) {
                String skinName = Settings.System.getString(MainActivity.this.getContentResolver(), "SkinName");
                if ("red".equals(skinName)) {
                    SkinCompatManager.getInstance().loadSkin("red.skin", 0);
                    MainActivity.this.setAlsButtonBg("red");
                } else if ("yellow".equals(skinName)) {
                    SkinCompatManager.getInstance().loadSkin("yellow.skin", 0);
    ...
    private View.OnClickListener mDialogBtnClickListener = new View.OnClickListener() {
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.lexus_ls_addapp_iv_cancel /*2131297013*/:
                    if (MainActivity.this.mPopupWindow != null) {
                        MainActivity.this.mPopupWindow.dismiss();
                        return;
                    }
                    return;
                case R.id.lexus_ls_addapp_iv_ok /*2131297014*/:
                    if (MainActivity.this.mPopupWindow != null) {
                        MainActivity.this.mPopupWindow.dismiss();
    ...
    /* access modifiers changed from: private */
    public PopupWindow skinPopupWindow;
    ...
    public void setAlsButtonBg(String skinType) {
        if (this.alsId7UiViewModel == null) {
            return;
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (UiThemeUtils.isALS_ID7_UI(this)) {
            getContentResolver().registerContentObserver(Settings.System.getUriFor("SkinName"), true, this.contentObserver);
        }
    }
    ...
    public void initAlsId7UiView() {
        ...
        launcherViewModel.setActivity(this);
        alsId7UiMainBinding = (AlsId7UiMainBinding) DataBindingUtil.setContentView(this, R.layout.activity_main_als_id7_ui);
        setAlsButtonBg(Settings.System.getString(getContentResolver(), "SkinName"));
        alsId7UiMainBinding.viewPage.setAdapter(new AlsId7UiViewPagerAdapter(getSupportFragmentManager()));
        ...
        alsId7UiMainBinding.blueIv.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                SkinCompatManager.getInstance().restoreDefaultTheme();
                Settings.System.putString(MainActivity.this.getContentResolver(), "SkinName", "blue");
                MainActivity.this.setAlsButtonBg("blue");
            }
        });
        alsId7UiMainBinding.yellowIv.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                MainActivity.alsId7UiMainBinding.skinLl.setVisibility(4);
                SkinCompatManager.getInstance().loadSkin("yellow.skin", 0);
                Settings.System.putString(MainActivity.this.getContentResolver(), "SkinName", "yellow");
                MainActivity.this.setAlsButtonBg("yellow");
            }
        });
        alsId7UiMainBinding.redIv.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                MainActivity.alsId7UiMainBinding.skinLl.setVisibility(4);
                SkinCompatManager.getInstance().loadSkin("red.skin", 0);
                Settings.System.putString(MainActivity.this.getContentResolver(), "SkinName", "red");
                MainActivity.this.setAlsButtonBg("red");
            }
        });
    ...
    public void initSkinPopupWindow() {
        View skinDialog = LayoutInflater.from(mainActivity).inflate(R.layout.als_id7_ui_skin_dialog, (ViewGroup) null);
        PopupWindow popupWindow = new PopupWindow(skinDialog, -2, -2, true);
        this.skinPopupWindow = popupWindow;
        popupWindow.setBackgroundDrawable(new ColorDrawable(0));
        this.skinPopupWindow.setOutsideTouchable(true);
        this.skinPopupWindow.setAnimationStyle(R.style.als_id7_ui_skin_dialogAnimStyle);
        int[] windowPos = calculatePopWindowPos(alsId7UiMainBinding.itemViewSkinDefault, alsId7UiMainBinding.alsRoot);
        windowPos[0] = windowPos[0] / 2;
        windowPos[0] = windowPos[0] - 85;
        windowPos[1] = windowPos[1] + 85;
        this.skinPopupWindow.showAtLocation(alsId7UiMainBinding.itemViewSkinDefault, 0, windowPos[0], windowPos[1]);
        skinDialog.findViewById(R.id.blue_iv).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                MainActivity.this.skinPopupWindow.dismiss();
                SkinCompatManager.getInstance().restoreDefaultTheme();
                Settings.System.putString(MainActivity.this.getContentResolver(), "SkinName", "blue");
                MainActivity.this.setAlsButtonBg("blue");
            }
        });
        skinDialog.findViewById(R.id.yellow_iv).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                MainActivity.this.skinPopupWindow.dismiss();
                SkinCompatManager.getInstance().loadSkin("yellow.skin", 0);
                Settings.System.putString(MainActivity.this.getContentResolver(), "SkinName", "yellow");
        ...
        skinDialog.findViewById(R.id.red_iv).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                MainActivity.this.skinPopupWindow.dismiss();
                SkinCompatManager.getInstance().loadSkin("red.skin", 0);
                Settings.System.putString(MainActivity.this.getContentResolver(), "SkinName", "red");
    ...
    public void updateData(WitsStatus witsStatus) {
        String str = TAG;
        Log.i(str, "type ======= " + witsStatus.type);
        switch (witsStatus.type) {
            ...
            case 21:
                ...
                Log.w(str, "updateData: play = " + isPlay);
        ...
        if (alsID7ViewModel2 != null) {
            ...
            new Handler().postDelayed(new Runnable() {
                public void run() {
                    try {
                        String topApp = PowerManagerApp.getStatusString("topApp");
                        Log.d(MainActivity.TAG, "onResume: topApp = " + topApp);
                        if (BuildConfig.APPLICATION_ID.equals(topApp)) {
                            MainActivity.this.alsID7ViewModel.setMusicPlayState(false);
                            MainActivity.this.alsID7ViewModel.setMusicPlayStop(true);
                        }
                    } catch (RemoteException e) {
                        e.printStackTrace();
                    }
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        ...
        if (UiThemeUtils.isAudi_mib3(this) && keyCode == 22) {
