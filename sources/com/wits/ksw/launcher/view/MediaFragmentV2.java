...
public class MediaFragmentV2 extends Fragment {
    ...
    private IContentObserver.Stub topAppContentObserver = new IContentObserver.Stub() { // from class: com.wits.ksw.launcher.view.MediaFragmentV2.1
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        MediaFragmentBindingV2 mediaFragmentBindingV2 = (MediaFragmentBindingV2) DataBindingUtil.inflate(inflater, C0899R.C0902layout.id7_v2_fragment_media, null, false);
