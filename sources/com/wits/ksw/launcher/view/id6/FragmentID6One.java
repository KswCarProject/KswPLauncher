...
public class FragmentID6One extends ID6BaseFragment implements View.OnKeyListener {
    ...
    private IContentObserver.Stub topAppContentObserver = new IContentObserver.Stub() { // from class: com.wits.ksw.launcher.view.id6.FragmentID6One.5
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ID6FragmentOne iD6FragmentOne = (ID6FragmentOne) DataBindingUtil.inflate(inflater, C0899R.C0902layout.id6_fragment_one, null, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.binding.id6BtImageView.setOnFocusChangeListener(new View.OnFocusChangeListener() { // from class: com.wits.ksw.launcher.view.id6.FragmentID6One.1
        ...
        this.binding.id6MusicIamgeView.setOnClickListener(new View.OnClickListener() { // from class: com.wits.ksw.launcher.view.id6.FragmentID6One.2
        ...
        this.binding.id6NavImageView.setOnClickListener(new View.OnClickListener() { // from class: com.wits.ksw.launcher.view.id6.FragmentID6One.3
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
        ...
        this.binding.id6BtImageView.setOnClickListener(new View.OnClickListener() { // from class: com.wits.ksw.launcher.view.id6.FragmentID6One.4
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
    ...
    public void setItemSelected(View view) {
        ...
        this.binding.id6BtImageView.setSelected(this.binding.id6BtImageView == view);
    }
