            ...
            switch (v.getId()) {
                case R.id.rb_benz_mbux_2021_coat_bg_1 /*2131297429*/:
                    ...
                    if (BcVieModel.mediaInfo.picBg.get() == null) {
                        obj = Benz2021KswDialogThemeActivity.this.getResources().getDrawable(BenzMbux2021KswConfigs.BG_OTHER[BenzMbux2021KswConfigs.bg_sel - 1]);
                    } else {
                ...
                case R.id.rb_benz_mbux_2021_coat_bg_2 /*2131297430*/:
                    ...
                    if (BcVieModel.mediaInfo.picBg.get() == null) {
                        obj2 = Benz2021KswDialogThemeActivity.this.getResources().getDrawable(BenzMbux2021KswConfigs.BG_OTHER[BenzMbux2021KswConfigs.bg_sel - 1]);
                    } else {
                    ...
                    if (MainActivity.benzMbux2021KswActivityBinding.benzMbux2021Viewpager.getCurrentItem() == 0) {
                        ImageView imageView3 = MainActivity.benzMbux2021KswActivityBinding.layoutMain2021;
                        BcVieModel bcVieModel13 = MainActivity.mBcVieModel;
                        imageView3.setBackground(BcVieModel.mediaInfo.picOne.get());
                        return;
                    } else if (MainActivity.benzMbux2021KswActivityBinding.benzMbux2021Viewpager.getCurrentItem() == 1) {
                        ImageView imageView4 = MainActivity.benzMbux2021KswActivityBinding.layoutMain2021;
                ...
                case R.id.rb_benz_mbux_2021_coat_bg_3 /*2131297431*/:
                    ...
                    if (BcVieModel.mediaInfo.picBg.get() == null) {
                        obj3 = Benz2021KswDialogThemeActivity.this.getResources().getDrawable(BenzMbux2021KswConfigs.BG_OTHER[BenzMbux2021KswConfigs.bg_sel - 1]);
                    } else {
                ...
                case R.id.rb_benz_mbux_2021_coat_bg_4 /*2131297432*/:
                    ...
                    if (BcVieModel.mediaInfo.picBg.get() == null) {
                        obj4 = Benz2021KswDialogThemeActivity.this.getResources().getDrawable(BenzMbux2021KswConfigs.BG_OTHER[BenzMbux2021KswConfigs.bg_sel - 1]);
                    } else {
                    ...
                    if (MainActivity.benzMbux2021KswActivityBinding.benzMbux2021Viewpager.getCurrentItem() == 0) {
                        ImageView imageView7 = MainActivity.benzMbux2021KswActivityBinding.layoutMain2021;
                        BcVieModel bcVieModel27 = MainActivity.mBcVieModel;
                        imageView7.setBackground(BcVieModel.mediaInfo.picOne.get());
                        return;
                    } else if (MainActivity.benzMbux2021KswActivityBinding.benzMbux2021Viewpager.getCurrentItem() == 1) {
                        ImageView imageView8 = MainActivity.benzMbux2021KswActivityBinding.layoutMain2021;
                ...
                case R.id.rb_benz_mbux_2021_coat_bg_5 /*2131297433*/:
                    ...
                    if (BcVieModel.mediaInfo.picBg.get() == null) {
                        obj5 = Benz2021KswDialogThemeActivity.this.getResources().getDrawable(BenzMbux2021KswConfigs.BG_OTHER[BenzMbux2021KswConfigs.bg_sel - 1]);
                    } else {
                ...
                case R.id.rb_benz_mbux_2021_coat_bg_6 /*2131297434*/:
                    ...
                    if (BcVieModel.mediaInfo.picBg.get() == null) {
                        obj6 = Benz2021KswDialogThemeActivity.this.getResources().getDrawable(BenzMbux2021KswConfigs.BG_OTHER[BenzMbux2021KswConfigs.bg_sel - 1]);
                    } else {
                    ...
                    if (MainActivity.benzMbux2021KswActivityBinding.benzMbux2021Viewpager.getCurrentItem() == 0) {
                        ImageView imageView11 = MainActivity.benzMbux2021KswActivityBinding.layoutMain2021;
                        BcVieModel bcVieModel41 = MainActivity.mBcVieModel;
                        imageView11.setBackground(BcVieModel.mediaInfo.picOne.get());
                        return;
                    } else if (MainActivity.benzMbux2021KswActivityBinding.benzMbux2021Viewpager.getCurrentItem() == 1) {
                        ImageView imageView12 = MainActivity.benzMbux2021KswActivityBinding.layoutMain2021;
                ...
                case R.id.rb_benz_mbux_2021_coat_bg_7 /*2131297435*/:
                    ...
                    if (BcVieModel.mediaInfo.picBg.get() == null) {
                        obj7 = Benz2021KswDialogThemeActivity.this.getResources().getDrawable(BenzMbux2021KswConfigs.BG_OTHER[BenzMbux2021KswConfigs.bg_sel - 1]);
                    } else {
