...
public class UiThemeUtils {
    ...
    public static int getCarManufacturer(Context context) {
        ...
        if (isBenz_NTG5(context) || isBenz_GS(context) || isBenz_NTG6(context) || isBenz_MBUX(context) || isBenz_MBUX_2021(context) || isBenz_NTG6_FY(context)) {
            return 2;
        }
        if (isAudi_MMI_4G(context) || isAudi_mib3(context) || isAudi_mib3_FY(context)) {
            return 3;
        }
        if (isLEXUS_UI(context) || isLEXUS_LS_UI(context)) {
            return 4;
        }
        return 0;
    }
