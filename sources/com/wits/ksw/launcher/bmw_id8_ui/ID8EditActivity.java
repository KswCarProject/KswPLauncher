...
public class ID8EditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(C0899R.C0902layout.activity_id8_launcher_edit);
        HorizontalScrollView horizontalScrollView = (HorizontalScrollView) findViewById(C0899R.C0901id.scrollView);
        this.scrollView = horizontalScrollView;
        horizontalScrollView.setOnScrollChangeListener(new View.OnScrollChangeListener() { // from class: com.wits.ksw.launcher.bmw_id8_ui.ID8EditActivity.1
        ...
        this.scrollView.setOnDragListener(new View.OnDragListener() { // from class: com.wits.ksw.launcher.bmw_id8_ui.ID8EditActivity.2
        ...
        LinearLayout linearLayout = (LinearLayout) findViewById(C0899R.C0901id.ll_container);
        this.llContainer = linearLayout;
        linearLayout.setOnClickListener(new View.OnClickListener() { // from class: com.wits.ksw.launcher.bmw_id8_ui.ID8EditActivity.3
