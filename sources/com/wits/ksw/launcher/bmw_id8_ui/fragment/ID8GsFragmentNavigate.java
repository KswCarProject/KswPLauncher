...
public class ID8GsFragmentNavigate extends Fragment {
    ...
    public static final int iconResId = 2131233101;
    public static final String name = "NAVIGATE";
    public static final int nameResId = 2131558788;

    @Override // android.support.p001v4.app.Fragment
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(C0899R.C0902layout.fragment_gs_navigate_edit, container, false);
        view.setOnDragListener(new CardId8GsOnDragListener(TAG, this, (ID8GsEditActivity) getActivity()));
        view.setOnLongClickListener(new DragClickListener(view, "NAVIGATE", C0899R.C0900drawable.id8_gs_main_left_icon_navi, C0899R.string.ksw_id8_abbr_tel_navigate));
