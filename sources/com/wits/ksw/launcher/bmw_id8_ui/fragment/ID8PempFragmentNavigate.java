...
public class ID8PempFragmentNavigate extends Fragment {
    ...
    public static final int iconResId = 2131234869;
    public static final String name = "NAVIGATE";
    public static final int nameResId = 2131558788;

    @Override // android.support.p001v4.app.Fragment
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(C0899R.C0902layout.fragment_pemp_navigate_edit, container, false);
        view.setOnDragListener(new CardId8PempOnDragListener(TAG, this, (ID8PempEditActivity) getActivity()));
        view.setOnLongClickListener(new DragClickListener(view, "NAVIGATE", C0899R.C0900drawable.pemp_id8_main_left_icon_navi, C0899R.string.ksw_id8_abbr_tel_navigate));
