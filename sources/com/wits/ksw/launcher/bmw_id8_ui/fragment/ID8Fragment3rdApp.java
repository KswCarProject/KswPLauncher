...
public class ID8Fragment3rdApp extends Fragment {
    ...
    public ID8Fragment3rdApp(String tag, TrdAppRemoveListener listener) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(C0899R.C0902layout.fragment_3rd_edit, container, false);
        ...
        remove.setOnClickListener(new View.OnClickListener() { // from class: com.wits.ksw.launcher.bmw_id8_ui.fragment.ID8Fragment3rdApp.1
