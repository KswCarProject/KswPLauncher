...
public class ID8PempFragmentDashboard extends Fragment {
    ...
    public static final int iconResId = 2131234866;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        FragmentPempDashboardEditBinding fragmentPempDashboardEditBinding = (FragmentPempDashboardEditBinding) DataBindingUtil.inflate(inflater, C0899R.C0902layout.fragment_pemp_dashboard_edit, container, false);
        ...
        view.setOnLongClickListener(new DragClickListener(view, "DASHBOARD", C0899R.C0900drawable.pemp_id8_main_left_icon_dashboard, C0899R.string.ksw_id8_dashboard));
