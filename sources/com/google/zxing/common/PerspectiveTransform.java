...
public final class PerspectiveTransform {
    ...
    public PerspectiveTransform times(PerspectiveTransform other) {
        ...
        float f19 = f16;
        float f20 = this.a32;
        float f21 = (f17 * f2) + (f18 * f4) + (f20 * f6);
        float f22 = (f17 * f8) + (f18 * f9) + (f20 * f10);
        float f23 = (f17 * f12) + (f18 * f13) + (f20 * f15);
        float f24 = this.a13;
        float f25 = this.a23;
        float f26 = (f2 * f24) + (f4 * f25);
        float f27 = this.a33;
        return new PerspectiveTransform(f7, f11, f19, f21, f22, f23, f26 + (f6 * f27), (f8 * f24) + (f9 * f25) + (f10 * f27), (f24 * f12) + (f25 * f13) + (f27 * f15));
    }
}
