...
public final class RSS14Reader extends AbstractRSSReader {
    ...
    private DataCharacter decodeDataCharacter(BitArray row, FinderPattern pattern, boolean outsideChar) throws NotFoundException {
        ...
        if (!z) {
            ...
            int i6 = oddWidest;
            int oddWidest2 = RSSUtils.getRSSvalue(evenCounts, 9 - oddWidest, false);
            int i7 = group;
            int i8 = oddWidest2;
            ...
            int evenWidest = 9 - oddWidest3;
            int[] iArr = counters;
            int vOdd2 = RSSUtils.getRSSvalue(oddCounts, oddWidest3, false);
            int i9 = oddWidest3;
            int oddWidest4 = RSSUtils.getRSSvalue(evenCounts, evenWidest, true);
            int i10 = evenWidest;
            int i11 = oddWidest4;
