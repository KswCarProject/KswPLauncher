...
public final class ObservableBufferTimed<T, U extends Collection<? super T>> extends AbstractObservableWithUpstream<T, U> {
    ...
    static final class BufferSkipBoundedObserver<T, U extends Collection<? super T>> extends QueueDrainObserver<T, U, U> implements Runnable, Disposable {
        ...
        public void onSubscribe(Disposable d) {
            if (DisposableHelper.validate(this.upstream, d)) {
                ...
                try {
                    ...
                    this.downstream.onSubscribe(this);
                    Scheduler.Worker worker = this.f311w;
                    long j = this.timeskip;
                    worker.schedulePeriodically(this, j, j, this.unit);
                    this.f311w.schedule(new RemoveFromBufferEmit(collection), this.timespan, this.unit);
                } catch (Throwable e) {
                    Exceptions.throwIfFatal(e);
                    d.dispose();
                    EmptyDisposable.error(e, this.downstream);
        ...
        public void onComplete() {
            ...
            this.done = true;
            if (enter()) {
                QueueDrainHelper.drainLoop(this.queue, this.downstream, false, this.f311w, this);
            }
        }
        ...
        public void run() {
            ...
            try {
                ...
                synchronized (this) {
                    ...
                    this.buffers.add(collection);
                    this.f311w.schedule(new RemoveFromBuffer(collection), this.timespan, this.unit);
                }
            } catch (Throwable e) {
                Exceptions.throwIfFatal(e);
                this.downstream.onError(e);
        ...
        final class RemoveFromBuffer implements Runnable {
            ...
            public void run() {
                synchronized (BufferSkipBoundedObserver.this) {
                    BufferSkipBoundedObserver.this.buffers.remove(this.f312b);
                }
                BufferSkipBoundedObserver bufferSkipBoundedObserver = BufferSkipBoundedObserver.this;
                bufferSkipBoundedObserver.fastPathOrderedEmit(this.f312b, false, bufferSkipBoundedObserver.f311w);
            }
        }
        ...
        final class RemoveFromBufferEmit implements Runnable {
            ...
            public void run() {
                ...
                BufferSkipBoundedObserver bufferSkipBoundedObserver = BufferSkipBoundedObserver.this;
                bufferSkipBoundedObserver.fastPathOrderedEmit(this.buffer, false, bufferSkipBoundedObserver.f311w);
            }
        }
    }
        ...
        public void onSubscribe(Disposable d) {
            if (DisposableHelper.validate(this.upstream, d)) {
                ...
                try {
                    ...
                    this.buffer = b;
                    this.downstream.onSubscribe(this);
                    Scheduler.Worker worker = this.f310w;
                    long j = this.timespan;
