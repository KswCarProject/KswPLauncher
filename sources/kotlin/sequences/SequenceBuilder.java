...
final class SequenceBuilder<T> extends SequenceScope<T> implements Iterator<T>, Continuation<Unit>, KMarkers {
    ...
    public boolean hasNext() {
        while (true) {
            ...
            step.resumeWith(Result.m93constructorimpl(Unit.INSTANCE));
        }
    }
