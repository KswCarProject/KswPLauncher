...
final class AdjustedTimeMark extends TimeMark {
    ...
    public final long m1283getAdjustmentUwyO8pc() {
    ...
    public long m1282elapsedNowUwyO8pc() {
        return Duration.m1324minusLRDsOJo(this.mark.m1418elapsedNowUwyO8pc(), m1283getAdjustmentUwyO8pc());
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1284plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1325plusLRDsOJo(m1283getAdjustmentUwyO8pc(), duration), (DefaultConstructorMarker) null);
    }
}
