...
public abstract class AbstractLongTimeSource implements TimeSource {
    ...
    private static final class LongTimeMark extends TimeMark {
        ...
        public long m1280elapsedNowUwyO8pc() {
        ...
        public TimeMark m1281plusLRDsOJo(long duration) {
            return new LongTimeMark(this.startedAt, this.timeSource, Duration.m1325plusLRDsOJo(this.offset, duration), (DefaultConstructorMarker) null);
        }
    }

    public TimeMark markNow() {
        return new LongTimeMark(read(), this, Duration.Companion.m1391getZEROUwyO8pc(), (DefaultConstructorMarker) null);
    }
}
