...
public abstract class TimeMark {
    ...
    public abstract long m1418elapsedNowUwyO8pc();

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1420plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this, duration, (DefaultConstructorMarker) null);
    }

    /* renamed from: minus-LRDsOJo  reason: not valid java name */
    public TimeMark m1419minusLRDsOJo(long duration) {
        return m1420plusLRDsOJo(Duration.m1341unaryMinusUwyO8pc(duration));
    }

    public final boolean hasPassedNow() {
        return !Duration.m1322isNegativeimpl(m1418elapsedNowUwyO8pc());
    }
