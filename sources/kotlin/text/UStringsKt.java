...
public final class UStringsKt {
    ...
    public static final String m1275toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m1277toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m1276toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m1274toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        if (UnsignedKt.uintCompare(r0, UInt.m99constructorimpl(255)) > 0) {
            return null;
        }
