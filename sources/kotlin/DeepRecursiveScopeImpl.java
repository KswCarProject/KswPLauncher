...
final class DeepRecursiveScopeImpl<T, R> extends DeepRecursiveScope<T, R> implements Continuation<R> {
    ...
    public final R runCallLoop() {
        ...
        while (true) {
            ...
            if (cont != null) {
                obj = DeepRecursiveKt.UNDEFINED_RESULT;
                if (!Result.m95equalsimpl0(obj, r)) {
                    ...
                    try {
                        ...
                        if (r2 != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                            ...
                            cont.resumeWith(Result.m93constructorimpl(r2));
                        }
                    } catch (Throwable e) {
                        Result.Companion companion2 = Result.Companion;
                        cont.resumeWith(Result.m93constructorimpl(ResultKt.createFailure(e)));
                    }
                }
            } else {
